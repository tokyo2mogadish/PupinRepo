       ...
       #Provera da li lice odgovorno za potpisivanje
        ...
        if( aop(bu,1041,5) >= 0 ):
            if not( aop(bu,1041,5) == suma(bu,1043,1044,5)-suma(bu,1045,1046,5) ):
                form_errors.append('Ako je AOP 1041 kol. 5 ≥ 0, onda je AOP 1041 kol. 5 = AOP-u (1043 + 1044 - 1045 - 1046) kol. 5  ')
        
        #10113
        if( aop(bu,1041,6) >= 0 ):
            if not( aop(bu,1041,6) == suma(bu,1043,1044,6)-suma(bu,1045,1046,6) ):
                form_errors.append('Ako je AOP 1041 kol. 6 ≥ 0, onda je AOP 1041 kol. 6 = AOP-u (1043 + 1044 - 1045 - 1046) kol. 6   ')
        
        #10114
        if( aop(bu,1042,5) > 0 ):
            if not( aop(bu,1042,5) == suma(bu,1045,1046,5)-suma(bu,1043,1044,5) ):
                form_errors.append('Ako je AOP 1042 kol. 5 > 0, onda je AOP 1042 kol. 5 = AOP-u (1045 + 1046 - 1043 -1044) kol. 5   ')
        
        #10115
        if( aop(bu,1042,6) > 0 ):
            if not( aop(bu,1042,6) == suma(bu,1045,1046,6)-suma(bu,1043,1044,6) ):
                form_errors.append('Ako je AOP 1042 kol. 6 > 0, onda je AOP 1042 kol. 6 = AOP-u (1045 + 1046 - 1043 -1044) kol. 6   ')
        ...
        if( aop(ioor,2031,5) >= 0 ):
            if not( aop(ioor,2031,5) == suma(ioor,2033,2034,5)-suma(ioor,2035,2036,5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2031 kol. 5 ≥ 0, onda je AOP 2031 kol. 5 = AOP-u (2033 + 2034 - 2035 - 2036) kol. 5   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2031,6) >= 0 ):
            if not( aop(ioor,2031,6) == suma(ioor,2033,2034,6)-suma(ioor,2035,2036,6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2031 kol. 6 ≥ 0, onda je AOP 2031 kol. 6 = AOP-u (2033 + 2034 - 2035 - 2036) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2032,5) > 0 ):
            if not( aop(ioor,2032,5) == suma(ioor,2035,2036,5)-suma(ioor,2033,2034,5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2032 kol. 5 > 0, onda je AOP 2032 kol. 5 = AOP-u (2035 + 2036 - 2033 - 2034) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2032,6) > 0 ):
            if not( aop(ioor,2032,6) == suma(ioor,2035,2036,6)-suma(ioor,2033,2034,6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2032 kol. 6 > 0, onda je AOP 2032 kol. 6 = AOP-u (2035 + 2036 - 2033 - 2034) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if(Zahtev.ObveznikInfo.Novoosnovan == True): 
            if not( aop(iotg,3067,3) == 0 ):
                ...
                dzbir =  0
                razlika = lzbir - dzbir
                form_warnings.append('AOP 3067 kol. 3 = 0 Novoosnovana pravna lica ne smeju imati prikazan podatak za prethodnu godinu '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3070,4) == aop(iotg,3067,3) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append('AOP 3070 kol. 4 = AOP-u 3067 kol. 3 Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga. '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if(Zahtev.ObveznikInfo.Novoosnovan == True):
            if not( suma(iopk,4001,4016,1) + suma(iopk,4033,4048,1) + suma(iopk,4065,4080,1) + suma(iopk,4097,4112,1) + suma(iopk,4129,4147,1) + suma(iopk,4147,4155,1) + suma(iopk,4165,4183,1) + suma(iopk,4203,4221,1) + suma(iopk,4241,4262,1) + suma(iopk,4285,4287,1)+ suma(iopk, 4291, 4293, 1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Zbir podataka na oznakama za AOP (4001 do 4016) + (4033 do 4048) + (4065 do 4080) + (4097 do 4112) + (4129 do 4137) + (4147 do 4155) + (4165 do 4183) + (4203 do 4221) + (4241 do 4262) + (4285 do 4287) + (4291 do 4293) = 0 Izveštaj o promenama na kapitalu za novoosnovane obveznike ne sme imati iskazane podatke za prethodni izveštajni period; '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4246,1) ==  suma_liste(iopk,[4241,4242, 4244],1) - suma_liste(iopk, [4243, 4245], 1)):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4246 = AOP-u (4241 + 4242 - 4243 + 4244 - 4245)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4260,1) == suma_liste(iopk, [4253,4255,4258 ], 1) - suma_liste(iopk, [4254,4256,4257,4259], 1) ):
            if not( suma_liste(iopk, [(4253,4255,4258 ], 1)  > suma_liste(iopk, [4254,4256,4257,4259], 1) ):
                form_errors.append('AOP 4260 = AOP-u (4253 - 4254 + 4255 - 4256 - 4257 + 4258 - 4259), ako je AOP (4253 + 4255 + 4258) > AOP-a (4254 + 4256 + 4257 + 4259)  ')
        
        #40057
        if( aop(iopk,4261,1) == suma_liste(iopk, [4254,4256,4257, 4259], 1) - suma_liste(iopk, [4253,4255,4258], 1) ):
            if not( suma_liste(iopk, [4253,4255,4258], 1)  < suma_liste(iopk, [4254,4256,4257,4259], 1) ):
                form_errors.append('AOP 4261 = AOP-u (4254 - 4253 - 4255 + 4256 + 4257 - 4258 + 4259), ako je AOP (4253 + 4255 + 4258) < AOP-a (4254 + 4256 + 4257 + 4259)  ')
        
        #40058
        if( suma_liste(iopk, [4260, 4261], 1) == 0):
            if not (suma_liste(iopk, [4253, 4255, 4258], 1) == suma_liste(iopk, [4254, 4256, 4257, 4259], 1) ):
                form_errors.append('AOP (4260  + 4261) = 0, ako je AOP (4253 + 4255 + 4258) = AOP-u (4254 + 4256 + 4257 + 4259) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake  ')
        
        #40059
        if( aop(iopk,4260,1) > 0 ):
            if not( aop(iopk,4261,1) == 0 ):
                form_errors.append('Ako je AOP 4260 > 0, onda je AOP 4261 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije s vlasnicima ')
        
        #40060
        if( aop(iopk,4261,1) > 0 ):
            if not( aop(iopk,4260,1) == 0 ):
                form_errors.append('Ako je AOP 4261 > 0, onda je AOP 4260 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije s vlasnicima ')
        ...
        if not( aop(iopk,4262,1) == suma_liste(iopk, [4246, 4247, 4249, 4251, 4260], 1) - suma_liste(iopk, [4248, 4250, 4252, 4261], 1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append("AOP 4262 = AOP-u (4246 + 4247 - 4248 + 4249 - 4250 +  4251 - 4252 + 4260 - 4261)  " +  "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")" )
        ...
        if not( aop(iopk,4268,1) == suma_liste(iopk, [4263, 4264, 4266], 1) - suma_liste(iopk, [4265, 4267], 1) ):
            form_errors.append('AOP 4268 = AOP-u (4263 + 4264 - 4265 + 4266 - 4267) ')
        ...
        if( aop(iopk,4282,1) == ( suma_liste(iopk, [4275, 4277, 4280], 1) - suma_liste(iopk, [4276, 4278, 4279, 4281], 1)  )):
            if not( suma_liste(iopk, [4275, 4277, 4280], 1)  > suma_liste(iopk, [4276, 4278, 4279, 4281], 1) ):
                form_errors.append('AOP 4282 = AOP-u (4275 - 4276 + 4277 - 4278 - 4279 + 4280 - 4281), ako je AOP (4275 + 4277 + 4280) > AOP-a (4276 + 4278 + 4279 + 4281)  ')
        
        #40138
        if( aop(iopk,4283,1) == ( suma_liste(iopk, [4276, 4278, 4279, 4281], 1) - suma_liste(iopk, [4275, 4277, 4280], 1) ) ):
            if not( suma_liste(iopk, [4275, 4277, 4280], 1) < suma_liste(iopk, [4276, 4278, 4279, 4281], 1) ):
                form_errors.append('AOP 4283 = AOP-u (4276 - 4275 - 4277 + 4278 + 4279 - 4280 + 4281), ako je AOP (4275 + 4277 + 4280) < AOP-a (4276 + 4278 + 4279 + 4281)  ')
        
        #40139
        if( aop(iopk,4282,1) + aop(iopk,4283,1) == 0 ):
            if not( suma_liste(iopk, [4275, 4277, 4280], 1) == suma_liste(iopk, [4276, 4278, 4279, 4281], 1)  ):
                form_errors.append('AOP (4282 + 4283) = 0, ako je AOP (4275 + 4277 + 4280) = AOP-u (4276 + 4278 + 4279 + 4281) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake  ')
        
        #40140
        if( aop(iopk,4282,1) > 0 ):
            if not( aop(iopk,4283,1) == 0 ):
                form_errors.append('Ako je AOP 4282 > 0, onda je AOP 4283 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije s vlasnicima  ')
        
        #40141
        if( aop(iopk,4283,1) > 0 ):
            if not( aop(iopk,4282,1) == 0 ):
                form_errors.append('Ako je AOP 4283 > 0, onda je AOP 4282 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije s vlasnicima  ')
        ...
        if not( aop(iopk,4284,1) == (suma_liste (iopk, [4268,4269,4271,4273, 4282],1) - suma_liste (iopk, [4270,4272, 4274, 4283],1)) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4284 = AOP-u (4268 + 4269 - 4270 + 4271 - 4272 + 4273 - 4274 + 4282 - 4283)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not (aop(iopk, 4246, 1)== aop(bs, 420, 7)):
            ...
            dzbir =  aop(bs, 420, 7)
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4246 = AOP-u 0420 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4262,1) == aop(bs,420,6) ):
            ...
            dzbir =  aop(bs,420,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4262 = AOP-u 0420 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4284,1) == aop(bs,420,5) ):
            ...
            dzbir =  aop(bs,420,5) 
            razlika = lzbir - dzbir
            form_errors.append("    AOP 4284 = AOP-u 0420 kol. 5 bilansa stanja     Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4017,1) == aop(iopk,4016,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4017 = AOP-u 4016     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4049,1) == aop(iopk,4048,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4049 = AOP-u 4048     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4081,1) == aop(iopk,4080,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4081 = AOP-u 4080     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4113,1) == aop(iopk,4112,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4113 = AOP-u 4112     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4138,1) == aop(iopk,4137,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4138 = AOP-u 4137     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4156,1) == aop(iopk,4155,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4156 = AOP-u 4155     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4184,1) == aop(iopk,4183,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4184 = AOP-u 4183     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4222,1) == aop(iopk,4221,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4222 = AOP-u 4221     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4263,1) == aop(iopk,4262,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4263 = AOP-u 4262     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4288,1) == aop(iopk,4287,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append("   AOP 4288 = AOP-u 4287     Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga.     "  + "(Levi zbir= " + str(lzbir) + ", Desni zbir= " + str(dzbir) + ", Razlika= " + str(razlika) + ")")
        ...
        if not( aop(iopk,4294,1) == aop(iopk,4293,1) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4294 = AOP-u 4293 Kontrolno pravilo zahteva računsko slaganje podataka; Ukoliko podaci nisu usaglašeni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga. '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(pp,10001,1) >= 0 ):
            form_errors.append(' Podatak o prosečnom broju zaposlenih mora biti upisan; ako nema zaposlenih upisuje se broj 0')
        
        #100002
        if not( aop(pp,10002,1) <= 1000 ):
            form_warnings.append(' Granične vrednosti date su da bi se izbegle slučajne greške prilikom iskazivanja broja zaposlenih;Zakonski zastupnik svojim potpisom potvrđuje ispravnost prikazanog broja zaposlenih;')
        ...
        for x in range (10100, 10300):
            if validiraj_spisak_pravnih_lica_obuhvacenih_konsolidacijom( x, aop(pps,x,2), aop(pps,x,3), aop(pps,x,4), aop(pps,x,5)) == False:
                form_errors.append("Na spisak pravnih lica koja su obuhvaćena konsolidacijom mora biti uneto bar jedno pravno lice Na spisak pravnih lica koja su obuhvaćena konsolidacijom niste uneli nijedan podatak (Greška u redu: " + str(x-10099) + ")")

        #100004                               
        for x in range (10100, 10300):
            if aop(pps,x,5) == Zahtev.ObveznikInfo.MaticniBroj:
                form_errors.append("Matično pravno lice ne može biti u spisku pravnih lica koja su obuhvaćena konsolidacijom! (Greška u redu: " + str(x-10099) + ")" )
        ...
        for x in range (10100, 10300):
            for y in range (x, 10300):
                if len(aop(pps,x,5)) != 0 and x != y and aop(pps,x,5) == aop(pps,y,5):
                    imaDuplikate = True
        if imaDuplikate:
            form_errors.append("Na spisku ne sme da se pojavi dva puta isto pravno lice Na spisak pravnih lica koja su obuhvaćena konsolidacijom ste uneli duplikate matičnih brojeva!")
        ...
        for x in range (10100, 10300):
            if (aop(ppsnum, x, 1)!=0):
                if not (aop(ppsnum, x, 1)==(x-10099)):
                    ...
                    form_errors.append("Redni broj na spisku mora biti unet po rastućem redosledu.  Na spisku pravnih lica koja su obuhvaćena konsolidacijom u koloni Redni broj podatak nije unet po rastućem redosledu(Greška u redu: "+str(x-10099)+")")
        ...
        for x in range(10100, 10300):
            if(aop(ppsnum, x, 1)==0):
                if( x != 10299 and aop(ppsnum, x+1,1)!=0 ):
                    form_errors.append( "GREŠKA U obrascu Posebni podaci, u Spisku pravnih lica obuhvaćenih konsolidacijom potrebno je popuniti kolonu “redni broj” po rastućem redosledu brojeva i bez preskakanja redova ")
        ...
        for x in range (10100, 10300):
            if (aop(ppsnum, x, 1) == 0):
                if (validiraj_spisak_pravnih_lica( x, aop(pps,x,2), aop(pps,x,3), aop(pps,x,4), aop(pps,x,5))):
                    ...
                    form_errors.append("U obrascu Posebni podaci, u Spisku pravnih lica obuhvaćenih konsolidacijom obveznik mora uneti redni broj ukoliko je popunio podatake o zavisnom pravnom licu i obrnuto ukoliko je dodao redni broj mora da popuni podatke o zavisnom pravnom licu. (Greška u redu: "+str(x-10099)+")")
        #100010            
        for x in range (10100, 10300):
            if (aop(ppsnum, x, 1) != 0 ):
