...
def Validate(Zahtev):
    try:
       ...
       #Provera da li lice odgovorno za potpisivanje
        ...
        if len(pp)==0:
            form_errors.append('Obrazac "Posebni podaci" nije popunjen')
        ...
        if not( suma(bs,1,54,5)+suma(bs,1,54,6)+suma(bs,1,54,7)+suma(bs,401,460,5)+suma(bs,401,460,6)+suma(bs,401,460,7)+suma(bu,1001,1110,5)+suma(bu,1001,1110,6)+suma(ioor,2001,2031,5)+suma(ioor,2001,2031,6)+suma(iotg,3001,3054,3)+suma(iotg,3001,3054,4)+suma(iopk,4001,4344,1) > 0 ):
            form_errors.append('Zbir podataka na oznakama za AOP (0001 do 0054) kol. 5 + (0001 do 0054) kol. 6 + (0001 do 0054) kol. 7 bilansa stanja + (0401 do 0460) kol. 5 + (0401 do 0460) kol. 6 + (0401 do 0460) kol. 7 bilansa stanja + (1001 do 1110) kol. 5 + (1001 do 1110) kol. 6 bilansa uspeha + (2001 do 2031) kol. 5 + (2001 do 2031) kol. 6 izveštaja o ostalom rezultatu + (3001 do 3054) kol. 3 + (3001 do 3054) kol. 4 izveštaja o tokovima gotovine + (4001 do 4344) kol.1 izveštaja o promenama na kapitalu  > 0 Finansijski izveštaj ne sme biti bez podataka; ')
            return {'doc_errors': doc_errors, 'doc_warnings': doc_warnings, 'form_warnings':form_warnings,'form_errors':form_errors, 'exceptions' : exceptionList}
        ...
        if not(proveriNapomene(bsNapomene, 1, 54, 4) or proveriNapomene(bsNapomene, 401, 460, 4) or proveriNapomene(buNapomene, 1001, 1110, 4) or proveriNapomene(ioorNapomene, 2001, 2031, 4)): 
            form_errors.append('Na AOP-u (0001 do 0054) bilansa stanja + (0401 do 0460) bilansa stanja + (1001 do 1110) bilansa uspeha + (2001 do 2031) izveštaja o ostalom rezultatu u koloni 4 (Napomena broj) mora biti unet bar jedan karakter Potrebno je popuniti kolonu 4 u skladu sa oznakama iz Napomena uz finansijske izveštaje')
        ...
        if( aop(bu,1103,5) > 0 ):
            if not( aop(bu,1103,5) == suma(bu,1104,1105,5)-suma(bu,1107,1108,5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 1103 kol. 5 > 0, onda je AOP 1103 kol. 5 = AOP-u (1104 + 1105 - 1107 - 1108) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(bu,1103,6) > 0 ):
            if not( aop(bu,1103,6) == suma(bu,1104,1105,6)-suma(bu,1107,1108,6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 1103 kol. 6 > 0, onda je AOP 1103 kol. 6 = AOP-u (1104 + 1105 - 1107 - 1108) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(bu,1106,5) > 0 ):
            if not( aop(bu,1106,5) == suma(bu,1107,1108,5)-suma(bu,1104,1105,5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 1106 kol. 5 > 0, onda je AOP 1106 kol. 5 = AOP-u (1107 + 1108 - 1104 -1105) kol. 5   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(bu,1106,6) > 0 ):
            if not( aop(bu,1106,6) == suma(bu,1107,1108,6)-suma(bu,1104,1105,6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 1106 kol. 6 > 0, onda je AOP 1106 kol. 6 = AOP-u (1107 + 1108 - 1104 -1105) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma(ioor,2001,2031,5) > 0 ):
            form_warnings.append('Zbir podataka na oznakama za AOP (2001 do 2031) kol. 5 > 0 Izveštaj o ostalom rezultatu, po pravilu,  mora imati iskazane podatke za tekući izveštajni period; Ukoliko podaci nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga ')
        ...
        if(Zahtev.ObveznikInfo.Novoosnovan == True): 
            if not( suma(ioor,2001,2031,6) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Zbir podataka na oznakama za AOP (2001 do 2031) kol. 6 = 0 Izveštaj o ostalom rezultatu za novoosnovane obveznike ne sme imati iskazane podatke za prethodni izveštajni period; '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        
        #20003
        if(Zahtev.ObveznikInfo.Novoosnovan == False): 
            if not( suma(ioor,2001,2031,6) > 0 ):
                form_warnings.append('Zbir podataka na oznakama za AOP (2001 do 2031) kol. 6 > 0 Izveštaj o ostalom rezultatu, po pravilu,  mora imati iskazane podatke za prethodni izveštajni period; Ukoliko podaci nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga ')
        ...
        if not( aop(ioor,2001,5) == aop(bu,1103,5) ):
            ...
            dzbir =  aop(bu,1103,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 2001 kol. 5 = AOP-u 1103 kol. 5 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(ioor,2001,6) == aop(bu,1103,6) ):
            ...
            dzbir =  aop(bu,1103,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 2001 kol. 6 = AOP-u 1103 kol. 6 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(ioor,2002,5) == aop(bu,1106,5) ):
            ...
            dzbir =  aop(bu,1106,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 2002 kol. 5 = AOP-u 1106 kol. 5 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(ioor,2002,6) == aop(bu,1106,6) ):
            ...
            dzbir =  aop(bu,1106,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 2002 kol. 6 = AOP-u 1106 kol. 6 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(ioor,2021,5) == suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017,2019],5) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 2021 kol. 5 = AOP-u (2003 + 2005 + 2007 + 2009 + 2011 + 2013 + 2015 + 2017 + 2019) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(ioor,2021,6) == suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017,2019],6) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 2021 kol. 6 = AOP-u (2003 + 2005 + 2007 + 2009 + 2011 + 2013 + 2015 + 2017 + 2019) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(ioor,2022,5) == suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018,2020],5) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 2022 kol. 5 = AOP-u (2004 + 2006 + 2008 + 2010 + 2012 + 2014 + 2016 + 2018 + 2020) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(ioor,2022,6) == suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018,2020],6) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 2022 kol. 6 = AOP-u (2004 + 2006 + 2008 + 2010 + 2012 + 2014 + 2016 + 2018 + 2020) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2021,5) > suma(ioor,2022,2023,5) ):
            if not( aop(ioor,2024,5) == aop(ioor,2021,5)-suma(ioor,2022,2023,5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 2024 kol. 5 = AOP-u (2021 - 2022 - 2023) kol. 5, ako je AOP 2021 kol. 5 > AOP-a (2022 + 2023) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2021,6) > suma(ioor,2022,2023,6) ):
            if not( aop(ioor,2024,6) == aop(ioor,2021,6)-suma(ioor,2022,2023,6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 2024 kol. 6 = AOP-u (2021 - 2022 - 2023) kol. 6, ako je AOP 2021 kol. 6 > AOP-a (2022 + 2023) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2021,5) < suma(ioor,2022,2023,5) ):
            if not( aop(ioor,2025,5) == suma(ioor,2022,2023,5)-aop(ioor,2021,5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 2025 kol. 5 = AOP-u (2022 - 2021 + 2023) kol. 5, ako je AOP 2021 kol. 5 < AOP-a (2022 + 2023) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2021,6) < suma(ioor,2022,2023,6) ):
            if not( aop(ioor,2025,6) == suma(ioor,2022,2023,6)-aop(ioor,2021,6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 2025 kol. 6 = AOP-u (2022 - 2021 + 2023) kol. 6, ako je AOP 2021 kol. 6 < AOP-a (2022 + 2023) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2021,5) == suma(ioor,2022,2023,5) ):
            if not( suma(ioor,2024,2025,5) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (2024 + 2025) kol. 5 = 0, ako je AOP 2021 kol. 5 = AOP-u (2022 + 2023) kol. 5 Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2021,6) == suma(ioor,2022,2023,6) ):
            if not( suma(ioor,2024,2025,6) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (2024 + 2025) kol. 6 = 0, ako je AOP 2021 kol. 6 = AOP-u (2022 + 2023) kol. 6 Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2024,5) > 0 ):
            if not( aop(ioor,2025,5) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2024 kol. 5 > 0, onda je AOP 2025 kol. 5 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2025,5) > 0 ):
            if not( aop(ioor,2024,5) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2025 kol. 5 > 0, onda je AOP 2024 kol. 5 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2024,6) > 0 ):
            if not( aop(ioor,2025,6) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2024 kol. 6 > 0, onda je AOP 2025 kol. 6 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2025,6) > 0 ):
            if not( aop(ioor,2024,6) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2025 kol. 6 > 0, onda je AOP 2024 kol. 6 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(ioor,[2021,2025],5) == suma(ioor,2022,2024,5) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (2021 + 2025) kol. 5 = AOP-u (2022 + 2023 + 2024) kol. 5 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(ioor,[2021,2025],6) == suma(ioor,2022,2024,6) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (2021 + 2025) kol. 6 = AOP-u (2022 + 2023 + 2024) kol. 6 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(ioor,[2001,2024],5) > suma_liste(ioor,[2002,2025],5) ):
            if not( aop(ioor,2026,5) == suma_liste(ioor,[2001,2024],5)-suma_liste(ioor,[2002,2025],5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 2026 kol. 5 = AOP-u (2001 + 2024 - 2002 - 2025) kol. 5, ako je AOP (2001 + 2024) kol. 5 > AOP-a (2002 + 2025) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(ioor,[2001,2024],6) > suma_liste(ioor,[2002,2025],6) ):
            if not( aop(ioor,2026,6) == suma_liste(ioor,[2001,2024],6)-suma_liste(ioor,[2002,2025],6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 2026 kol. 6 = AOP-u (2001 + 2024 - 2002 - 2025) kol. 6, ako je AOP (2001 + 2024) kol. 6 > AOP-a (2002 + 2025) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(ioor,[2001,2024],5) < suma_liste(ioor,[2002,2025],5) ):
            if not( aop(ioor,2029,5) == suma_liste(ioor,[2002,2025],5)-suma_liste(ioor,[2001,2024],5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 2029 kol. 5 = AOP-u (2002 - 2001 - 2024 + 2025) kol. 5, ako je AOP (2001 + 2024) kol. 5 < AOP-a (2002 + 2025) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(ioor,[2001,2024],6) < suma_liste(ioor,[2002,2025],6) ):
            if not( aop(ioor,2029,6) == suma_liste(ioor,[2002,2025],6)-suma_liste(ioor,[2001,2024],6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 2029 kol. 6 = AOP-u (2002 - 2001 - 2024 + 2025) kol. 6, ako je AOP (2001 + 2024) kol. 6 < AOP-a (2002 + 2025) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(ioor,[2001,2024],5) == suma_liste(ioor,[2002,2025],5) ):
            if not( suma_liste(ioor,[2026,2029],5) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (2026 + 2029) kol. 5 = 0, ako je AOP (2001 + 2024) kol. 5 = AOP-u (2002 + 2025) kol. 5 Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(ioor,[2001,2024],6) == suma_liste(ioor,[2002,2025],6) ):
            if not( suma_liste(ioor,[2026,2029],6) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (2026 + 2029) kol. 6 = 0, ako je AOP (2001 + 2024) kol. 6 = AOP-u (2002 + 2025) kol. 6 Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2026,5) > 0 ):
            if not( aop(ioor,2029,5) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2026 kol. 5 > 0, onda je AOP 2029 kol. 5 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2029,5) > 0 ):
            if not( aop(ioor,2026,5) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2029 kol. 5 > 0, onda je AOP 2026 kol. 5 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2026,6) > 0 ):
            if not( aop(ioor,2029,6) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2026 kol. 6 > 0, onda je AOP 2029 kol. 6 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2029,6) > 0 ):
            if not( aop(ioor,2026,6) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2029 kol. 6 > 0, onda je AOP 2026 kol. 6 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(ioor,[2001,2024,2029],5) == suma_liste(ioor,[2002,2025,2026],5) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (2001 + 2024 + 2029) kol. 5 = AOP-u (2002 + 2025 + 2026) kol. 5 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(ioor,[2001,2024,2029],6) == suma_liste(ioor,[2002,2025,2026],6) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (2001 + 2024 + 2029) kol. 6 = AOP-u (2002 + 2025 + 2026) kol. 6 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2026,5) > 0 ):
            if not( aop(ioor,2026,5) == suma(ioor,2027,2028,5)-suma(ioor,2030,2031,5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2026 kol. 5 > 0, onda je AOP 2026 kol. 5 = AOP-u (2027 + 2028 - 2030 - 2031) kol. 5   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2026,6) > 0 ):
            if not( aop(ioor,2026,6) == suma(ioor,2027,2028,6)-suma(ioor,2030,2031,6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2026 kol. 6 > 0, onda je AOP 2026 kol. 6 = AOP-u (2027 + 2028 - 2030 - 2031) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2029,5) > 0 ):
            if not( aop(ioor,2029,5) == suma(ioor,2030,2031,5)-suma(ioor,2027,2028,5) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2029 kol. 5 > 0, onda je AOP 2029 kol. 5 = AOP-u (2030 + 2031 - 2027 - 2028) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(ioor,2029,6) > 0 ):
            if not( aop(ioor,2029,6) == suma(ioor,2030,2031,6)-suma(ioor,2027,2028,6) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 2029 kol. 6 > 0, onda je AOP 2029 kol. 6 = AOP-u (2030 + 2031 - 2027 - 2028) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma(iotg,3001,3054,3) > 0 ):
            form_warnings.append('Zbir podataka na oznakama za AOP (3001 do 3054) kol. 3 > 0 Izveštaj o tokovima gotovine, po pravilu,  mora imati iskazane podatke za tekući izveštajni period; Ukoliko podaci nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga ')
        ...
        if(Zahtev.ObveznikInfo.Novoosnovan == True): 
            if not( suma(iotg,3001,3054,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Zbir podataka na oznakama za AOP (3001 do 3054) kol. 4 = 0 Izveštaj o tokovima gotovine za novoosnovane obveznike ne sme imati iskazane podatke za prethodni izveštajni period; '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        
        #30003
        if(Zahtev.ObveznikInfo.Novoosnovan == False): 
            if not( suma(iotg,3001,3054,4) > 0 ):
                form_warnings.append('Zbir podataka na oznakama za AOP (3001 do 3054) kol. 4 > 0 Izveštaj o tokovima gotovine, po pravilu,  mora imati iskazane podatke za prethodni izveštajni period; Ukoliko podaci nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga ')
        ...
        if not( aop(iotg,3001,3) == suma(iotg,3002,3006,3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3001 kol. 3 = AOP-u (3002 + 3003 + 3004 + 3005 + 3006) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3001,4) == suma(iotg,3002,3006,4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3001 kol. 4 = AOP-u (3002 + 3003 + 3004 + 3005 + 3006) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3007,3) == suma(iotg,3008,3016,3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3007 kol. 3 = AOP-u (3008 + 3009 + 3010 + 3011 + 3012 + 3013 + 3014 + 3015 + 3016) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3007,4) == suma(iotg,3008,3016,4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3007 kol. 4 = AOP-u (3008 + 3009 + 3010 + 3011 + 3012 + 3013 + 3014 + 3015 + 3016) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3001,3) > aop(iotg,3007,3) ):
            if not( aop(iotg,3017,3) == aop(iotg,3001,3)-aop(iotg,3007,3) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append(' AOP 3017 kol. 3 = AOP-u (3001 - 3007) kol. 3, ako je AOP 3001 kol. 3 > AOP-a 3007 kol. 3   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3001,4) > aop(iotg,3007,4) ):
            if not( aop(iotg,3017,4) == aop(iotg,3001,4)-aop(iotg,3007,4) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append(' AOP 3017 kol. 4 = AOP-u (3001 - 3007) kol. 4, ako je AOP 3001 kol. 4 > AOP-a 3007 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3001,3) < aop(iotg,3007,3) ):
            if not( aop(iotg,3018,3) == aop(iotg,3007,3)-aop(iotg,3001,3) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3018 kol. 3 = AOP-u (3007 - 3001) kol. 3, ako je AOP 3001 kol. 3 < AOP-a 3007 kol. 3    '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3001,4) < aop(iotg,3007,4) ):
            if not( aop(iotg,3018,4) == aop(iotg,3007,4)-aop(iotg,3001,4) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3018 kol. 4 = AOP-u (3007 - 3001) kol. 4, ako je AOP 3001 kol. 4 < AOP-a 3007 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3001,3) == aop(iotg,3007,3) ):
            if not( suma(iotg,3017,3018,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (3017 + 3018) kol. 3 = 0, ako je AOP 3001 kol. 3 = AOP-u 3007 kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3001,4) == aop(iotg,3007,4) ):
            if not( suma(iotg,3017,3018,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (3017 + 3018) kol. 4 = 0, ako je AOP 3001 kol. 4 = AOP-u 3007 kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3017,3) > 0 ):
            if not( aop(iotg,3018,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3017 kol. 3 > 0 onda je AOP 3018 kol. 3 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3018,3) > 0 ):
            if not( aop(iotg,3017,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3018 kol. 3 > 0 onda je AOP 3017 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3017,4) > 0 ):
            if not( aop(iotg,3018,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3017 kol. 4 > 0 onda je AOP 3018 kol. 4 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3018,4) > 0 ):
            if not( aop(iotg,3017,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3018 kol. 4 > 0 onda je AOP 3017 kol. 4 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(iotg,[3001,3018],3) == suma_liste(iotg,[3007,3017],3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (3001 + 3018) kol. 3 = AOP-u (3007 + 3017) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(iotg,[3001,3018],4) == suma_liste(iotg,[3007,3017],4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (3001 + 3018) kol. 4 = AOP-u (3007 + 3017) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3019,3) == suma(iotg,3020,3024,3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3019 kol. 3 = AOP-u (3020 + 3021 + 3022 + 3023 + 3024) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3019,4) == suma(iotg,3020,3024,4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3019 kol. 4 = AOP-u (3020 + 3021 + 3022 + 3023 + 3024) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3025,3) == suma(iotg,3026,3028,3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3025 kol. 3 = AOP-u (3026 + 3027 + 3028) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3025,4) == suma(iotg,3026,3028,4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3025 kol. 4 = AOP-u (3026 + 3027 + 3028) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3019,3) > aop(iotg,3025,3) ):
            if not( aop(iotg,3029,3) == aop(iotg,3019,3)-aop(iotg,3025,3) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3029 kol. 3 = AOP-u (3019 - 3025) kol. 3, ako je AOP 3019 kol. 3 > AOP-a 3025 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3019,4) > aop(iotg,3025,4) ):
            if not( aop(iotg,3029,4) == aop(iotg,3019,4)-aop(iotg,3025,4) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3029 kol. 4 = AOP-u (3019 - 3025) kol. 4, ako je AOP 3019 kol. 4 > AOP-a 3025 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3019,3) < aop(iotg,3025,3) ):
            if not( aop(iotg,3030,3) == aop(iotg,3025,3)-aop(iotg,3019,3) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3030 kol. 3 = AOP-u (3025 - 3019) kol. 3,ako je AOP 3019 kol. 3 < AOP-a 3025 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3019,4) < aop(iotg,3025,4) ):
            if not( aop(iotg,3030,4) == aop(iotg,3025,4)-aop(iotg,3019,4) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3030 kol. 4 = AOP-u (3025 - 3019) kol. 4,ako je AOP 3019 kol. 4 < AOP-a 3025 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3019,3) == aop(iotg,3025,3) ):
            if not( suma(iotg,3029,3030,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (3029 + 3030) kol. 3 = 0, ako je AOP 3019 kol. 3 = AOP-u 3025 kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3019,4) == aop(iotg,3025,4) ):
            if not( suma(iotg,3029,3030,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (3029 + 3030) kol. 4 = 0, ako je AOP 3019 kol. 4 = AOP-u 3025 kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3029,3) > 0 ):
            if not( aop(iotg,3030,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3029 kol. 3 > 0 onda je AOP 3030 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3030,3) > 0 ):
            if not( aop(iotg,3029,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3030 kol. 3 > 0 onda je AOP 3029 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3029,4) > 0 ):
            if not( aop(iotg,3030,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3029 kol. 4 > 0 onda je AOP 3030 kol. 4 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3030,4) > 0 ):
            if not( aop(iotg,3029,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3030 kol. 4 > 0 onda je AOP 3029 kol. 4 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(iotg,[3019,3030],3) == suma_liste(iotg,[3025,3029],3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (3019 + 3030) kol. 3 = AOP-u (3025 + 3029) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(iotg,[3019,3030],4) == suma_liste(iotg,[3025,3029],4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (3019 + 3030) kol. 4 = AOP-u (3025 + 3029) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3031,3) == suma(iotg,3032,3036,3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3031 kol. 3 = AOP-u (3032 + 3033 + 3034 + 3035 + 3036) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3031,4) == suma(iotg,3032,3036,4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3031 kol. 4 = AOP-u (3032 + 3033 + 3034 + 3035 + 3036) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3037,3) == suma(iotg,3038,3044,3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3037 kol. 3 = AOP-u (3038 + 3039 + 3040 + 3041 + 3042 + 3043 + 3044) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3037,4) == suma(iotg,3038,3044,4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3037 kol. 4 = AOP-u (3038 + 3039 + 3040 + 3041 + 3042 + 3043 + 3044) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3031,3) > aop(iotg,3037,3) ):
            if not( aop(iotg,3045,3) == aop(iotg,3031,3)-aop(iotg,3037,3) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3045 kol. 3 = AOP-u (3031 - 3037) kol. 3, ako je AOP 3031 kol. 3 > AOP-a 3037 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3031,4) > aop(iotg,3037,4) ):
            if not( aop(iotg,3045,4) == aop(iotg,3031,4)-aop(iotg,3037,4) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3045 kol. 4 = AOP-u (3031 - 3037) kol. 4, ako je AOP 3031 kol. 4 > AOP-a 3037 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3031,3) < aop(iotg,3037,3) ):
            if not( aop(iotg,3046,3) == aop(iotg,3037,3)-aop(iotg,3031,3) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3046 kol. 3 = AOP-u (3037 - 3031) kol. 3, ako je AOP 3031 kol. 3 < AOP-a 3037 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3031,4) < aop(iotg,3037,4) ):
            if not( aop(iotg,3046,4) == aop(iotg,3037,4)-aop(iotg,3031,4) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3046 kol. 4 = AOP-u (3037 - 3031) kol. 4, ako je AOP 3031 kol. 4 < AOP-a 3037 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3031,3) == aop(iotg,3037,3) ):
            if not( suma(iotg,3045,3046,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (3045 + 3046) kol. 3 = 0, ako je AOP 3031 kol. 3 = AOP-u 3037 kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3031,4) == aop(iotg,3037,4) ):
            if not( suma(iotg,3045,3046,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (3045 + 3046) kol. 4 = 0, ako je AOP 3031 kol. 4 = AOP-u 3037 kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3045,3) > 0 ):
            if not( aop(iotg,3046,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3045 kol. 3 > 0 onda je AOP 3046 kol. 3 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3046,3) > 0 ):
            if not( aop(iotg,3045,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3046 kol. 3 > 0 onda je AOP 3045 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3045,4) > 0 ):
            if not( aop(iotg,3046,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3045 kol. 4 > 0 onda je AOP 3046 kol. 4 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3046,4) > 0 ):
            if not( aop(iotg,3045,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3046 kol. 4 > 0 onda je AOP 3045 kol. 4 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(iotg,[3031,3046],3) == suma_liste(iotg,[3037,3045],3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (3031 + 3046) kol. 3 = AOP-u (3037 + 3045) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(iotg,[3031,3046],4) == suma_liste(iotg,[3037,3045],4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (3031 + 3046) kol. 4 = AOP-u (3037 + 3045) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3047,3) == suma_liste(iotg,[3001,3019,3031],3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3047 kol. 3 = AOP-u (3001 + 3019 + 3031) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3047,4) == suma_liste(iotg,[3001,3019,3031],4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3047 kol. 4 = AOP-u (3001 + 3019 + 3031) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3048,3) == suma_liste(iotg,[3007,3025,3037],3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3048 kol. 3 = AOP-u (3007 + 3025 + 3037) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3048,4) == suma_liste(iotg,[3007,3025,3037],4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3048 kol. 4 = AOP-u (3007 + 3025 + 3037) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3047,3) > aop(iotg,3048,3) ):
            if not( aop(iotg,3049,3) == aop(iotg,3047,3)-aop(iotg,3048,3) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3049 kol. 3 = AOP-u (3047 - 3048) kol. 3, ako je AOP 3047 kol. 3 > AOP-a 3048 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3047,4) > aop(iotg,3048,4) ):
            if not( aop(iotg,3049,4) == aop(iotg,3047,4)-aop(iotg,3048,4) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3049 kol. 4 = AOP-u (3047 - 3048) kol. 4, ako je AOP 3047 kol. 4 > AOP-a 3048 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3047,3) < aop(iotg,3048,3) ):
            if not( aop(iotg,3050,3) == aop(iotg,3048,3)-aop(iotg,3047,3) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3050 kol. 3 = AOP-u (3048 - 3047) kol. 3,  ako je AOP 3047 kol. 3 < AOP-a 3048 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3047,4) < aop(iotg,3048,4) ):
            if not( aop(iotg,3050,4) == aop(iotg,3048,4)-aop(iotg,3047,4) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3050 kol. 4 = AOP-u (3048 - 3047) kol. 4,  ako je AOP 3047 kol. 4 < AOP-a 3048 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3047,3) == aop(iotg,3048,3) ):
            if not( suma(iotg,3049,3050,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (3049 + 3050) kol. 3 = 0, ako je AOP 3047 kol. 3 = AOP-u 3048 kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3047,4) == aop(iotg,3048,4) ):
            if not( suma(iotg,3049,3050,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP (3049 + 3050) kol. 4 = 0, ako je AOP 3047 kol. 4 = AOP-u 3048 kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3049,3) > 0 ):
            if not( aop(iotg,3050,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3049 kol. 3 > 0 onda je AOP 3050 kol. 3 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3050,3) > 0 ):
            if not( aop(iotg,3049,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3050 kol. 3 > 0 onda je AOP 3049 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3049,4) > 0 ):
            if not( aop(iotg,3050,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3049 kol. 4 > 0 onda je AOP 3050 kol. 4 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iotg,3050,4) > 0 ):
            if not( aop(iotg,3049,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 3050 kol. 4 > 0 onda je AOP 3049 kol. 4 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(iotg,[3047,3050],3) == suma(iotg,3048,3049,3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (3047 + 3050) kol. 3 = AOP-u (3048 + 3049) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma_liste(iotg,[3047,3050],4) == suma(iotg,3048,3049,4) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (3047 + 3050) kol. 4 = AOP-u (3048 + 3049) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if(Zahtev.ObveznikInfo.Novoosnovan == True): 
            if not( aop(iotg,3051,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP 3051 kol. 3 = 0 Novoosnovana pravna lica ne smeju imati prikazan podatak za prethodnu godinu '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(iotg,[3049,3051,3052],3) > suma_liste(iotg,[3050,3053],3) ):
            if not( aop(iotg,3054,3) == suma_liste(iotg,[3049,3051,3052],3)-suma_liste(iotg,[3050,3053],3) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3054 kol. 3 = AOP-u (3049 - 3050 + 3051 + 3052 - 3053) kol. 3, ako je AOP (3049 + 3051 + 3052) kol. 3 > AOP-a (3050 + 3053) kol. 3   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(iotg,[3049,3051,3052],4) > suma_liste(iotg,[3050,3053],4) ):
            if not( aop(iotg,3054,4) == suma_liste(iotg,[3049,3051,3052],4)-suma_liste(iotg,[3050,3053],4) ):
                ...
                razlika = lzbir - dzbir
                form_errors.append('AOP 3054 kol. 4 = AOP-u (3049 - 3050 + 3051 + 3052 - 3053) kol. 4, ako je AOP (3049 + 3051 + 3052) kol. 4 > AOP-a (3050 + 3053) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(iotg,[3049,3051,3052],3) <= suma_liste(iotg,[3050,3053],3) ):
            if not( aop(iotg,3054,3) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP 3054 kol. 3 = 0, ako je AOP (3049 + 3051 + 3052) kol. 3 ≤ AOP-a (3050 + 3053) kol. 3   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( suma_liste(iotg,[3049,3051,3052],4) <= suma_liste(iotg,[3050,3053],4) ):
            if not( aop(iotg,3054,4) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('AOP 3054 kol. 4 = 0, ako je AOP (3049 + 3051 + 3052) kol. 4 ≤ AOP-a (3050 + 3053) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3054,4) == aop(iotg,3051,3) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 3054 kol. 4 = AOP-u 3051 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3054,3) == aop(bs,44,5) ):
            ...
            dzbir =  aop(bs,44,5) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 3054 kol. 3 = AOP-u 0044 kol. 5 bilansa stanja Računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju, po pravilu  treba da postoji; Ukoliko su uneti podaci tačni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga. '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iotg,3054,4) == aop(bs,44,6) ):
            ...
            dzbir =  aop(bs,44,6) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 3054 kol. 4 = AOP-u 0044 kol. 6 bilansa stanja Računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju, po pravilu  treba da postoji; Ukoliko su uneti podaci tačni, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga. '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( suma(iopk,4018, 4026, 1) +suma(iopk,4043, 4050, 1) +suma(iopk,4067, 4074, 1) +suma(iopk,4091, 4098, 1) +suma(iopk,4115, 4122, 1) +suma(iopk,4140, 4148, 1) +suma(iopk,4167, 4176, 1) +suma(iopk,4198, 4210, 1) +suma(iopk,4227, 4234, 1) +suma(iopk,4252, 4260, 1) +suma(iopk,4277, 4284, 1) +suma(iopk,4304, 4314, 1)+ aop(iopk, 4320, 1) +suma(iopk,4337, 4344, 1)  > 0 ):
            form_warnings.append('Zbir podataka na oznakama za AOP (4018 do 4026) + (4043 do 4050) + (4067 do 4074) + (4091 do 4098) + (4115 do 4122) + (4140 do 4148) + (4167 do 4176) + (4198 do 4210) + (4227 do 4234) + (4252 do 4260) + (4277 do 4284) + (4304 do 4314) + 4320 + (4337 do 4344) > 0 Izveštaj o promenama na kapitalu, po pravilu,  mora imati iskazane podatke za tekući izveštajni period; Ukoliko podaci nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga ')
        ...
        if(Zahtev.ObveznikInfo.Novoosnovan == True):
            if not( suma(iopk,4001, 4017, 1) +suma(iopk,4027, 4042, 1) +suma(iopk,4051, 4066, 1) +suma(iopk,4075, 4090, 1) +suma(iopk,4099, 4114, 1) +suma(iopk,4123, 4139, 1) +suma(iopk,4149, 4166, 1) +suma(iopk,4177, 4197, 1) +suma(iopk,4211, 4226, 1) +suma(iopk,4235, 4251, 1) +suma(iopk,4261, 4276, 1) +suma(iopk,4285, 4303, 1) +suma(iopk,4315, 4319, 1) +suma(iopk,4321, 4336, 1)  == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Zbir podataka na oznakama za AOP (4001 do 4017) + (4027 do 4042) + (4051 do 4066) + (4075 do 4090) + (4099 do 4114) + (4123 do 4139) + (4149 do 4166) + (4177 do 4197) + (4211 do 4226) + (4235 do 4251) + (4261 do 4276) + (4285 do 4303) + (4315 do 4319) + (4321 do 4336) = 0 Izveštaj o promenama na kapitalu za novoosnovane obveznike ne sme imati iskazane podatke za prethodni izveštajni period; '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        
        #40003
        if(Zahtev.ObveznikInfo.Novoosnovan == False):
            if not( suma(iopk,4001, 4017, 1) +suma(iopk,4027, 4042, 1) +suma(iopk,4051, 4066, 1) +suma(iopk,4075, 4090, 1) +suma(iopk,4099, 4114, 1) +suma(iopk,4123, 4139, 1) +suma(iopk,4149, 4166, 1) +suma(iopk,4177, 4197, 1) +suma(iopk,4211, 4226, 1) +suma(iopk,4235, 4251, 1) +suma(iopk,4261, 4276, 1) +suma(iopk,4285, 4303, 1) +suma(iopk,4315, 4319, 1) +suma(iopk,4321, 4336, 1)  > 0 ):
                form_warnings.append('Zbir podataka na oznakama za AOP (4001 do 4017) + (4027 do 4042) + (4051 do 4066) + (4075 do 4090) + (4099 do 4114) + (4123 do 4139) + (4149 do 4166) + (4177 do 4197) + (4211 do 4226) + (4235 do 4251) + (4261 do 4276) + (4285 do 4303) + (4315 do 4319) + (4321 do 4336) > 0 Izveštaj o promenama na kapitalu, po pravilu,  mora imati iskazane podatke za prethodni izveštajni period; Ukoliko podaci nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga ')
        ...
        if not( aop(iopk,4030,1) == suma(iopk,4027,4028,1)-aop(iopk,4029,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4030 = AOP-u (4027 + 4028 - 4029)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4054,1) == suma(iopk,4051,4052,1)-aop(iopk,4053,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4054 = AOP-u (4051 + 4052 - 4053)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4078,1) == suma(iopk,4075,4076,1)-aop(iopk,4077,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4078 = AOP-u (4075 + 4076 - 4077)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4102,1) == suma(iopk,4099,4100,1)-aop(iopk,4101,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4102 = AOP-u (4099 + 4100 - 4101)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4126,1) == suma(iopk,4123,4124,1)-aop(iopk,4125,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4126 = AOP-u (4123 + 4124 - 4125)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4152,1) == suma(iopk,4149,4150,1)-aop(iopk,4151,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4152 = AOP-u (4149 + 4150 - 4151)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4180,1) == suma(iopk,4177,4178,1)-aop(iopk,4179,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4180 = AOP-u (4177 + 4178 - 4179)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4214,1) == suma(iopk,4211,4212,1)-aop(iopk,4213,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4214 = AOP-u (4211 + 4212 - 4213)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4238,1) == suma(iopk,4235,4236,1)-aop(iopk,4237,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4238 = AOP-u (4235 + 4236 - 4237)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4264,1) == suma(iopk,4261,4262,1)-aop(iopk,4263,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4264 = AOP-u (4261 + 4262 - 4263)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4288,1) == suma(iopk,4285,4286,1)-aop(iopk,4287,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4288 = AOP-u (4285 + 4286 - 4287)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4324,1) == suma(iopk,4321,4322,1)-aop(iopk,4323,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4324 = AOP-u (4321 + 4322 - 4323)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4177,1) == suma_liste(iopk,[4001,4027,4051,4075,4099,4123,4149],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4177 = AOP-u (4001 + 4027 + 4051 + 4075 + 4099 + 4123 + 4149)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4178,1) == suma_liste(iopk,[4002,4028,4052,4076,4100,4124,4150],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4178 = AOP-u (4002 + 4028 + 4052 + 4076 + 4100 + 4124 + 4150)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4179,1) == suma_liste(iopk,[4003,4029,4053,4077,4101,4125,4151],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4179 = AOP-u (4003 + 4029 + 4053 + 4077 + 4101 + 4125 + 4151)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4180,1) == suma_liste(iopk,[4004,4030,4054,4078,4102,4126,4152],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4180 = AOP-u (4004 + 4030 + 4054 + 4078 + 4102 + 4126 + 4152)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4285,1) == suma_liste(iopk,[4211,4235,4261],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4285 = AOP-u (4211 + 4235 + 4261)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4286,1) == suma_liste(iopk,[4212,4236,4262],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4286 = AOP-u (4212 + 4236 + 4262)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4287,1) == suma_liste(iopk,[4213,4237,4263],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4287 = AOP-u (4213 + 4237 + 4263)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4288,1) == suma_liste(iopk,[4214,4238,4264],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4288 = AOP-u (4214 + 4238 + 4264)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4315,1) == aop(iopk,4177,1) - aop(iopk,4285,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4315 = AOP-u (4177 - 4285)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4315,1) > 0 ):
            if not( aop(iopk,4321,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4315 > 0, onda je AOP 4321 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4321,1) > 0 ):
            if not( aop(iopk,4315,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4321 > 0, onda je AOP 4315 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4316,1) == aop(iopk,4180,1) - aop(iopk,4288,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4316 = AOP-u (4180 - 4288)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4316,1) > 0 ):
            if not( aop(iopk,4324,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4316 > 0, onda je AOP 4324 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4324,1) > 0 ):
            if not( aop(iopk,4316,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4324 > 0, onda je AOP 4316 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4181,1) == suma_liste(iopk,[4005,4055,4079],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4181 = AOP-u (4005 + 4055 + 4079)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4182,1) == aop(iopk,4127,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4182 = AOP-u 4127  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4183,1) == aop(iopk,4128,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4183 = AOP-u 4128  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4289,1) == aop(iopk,4265,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4289 = AOP-u 4265  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4184,1) == suma_liste(iopk,[4006,4031,4103,4153],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4184 = AOP-u (4006 + 4031 + 4103 + 4153)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4290,1) == aop(iopk,4215,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4290 = AOP-u 4215  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4291,1) == aop(iopk,4239,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4291 = AOP-u 4239  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4292,1) == aop(iopk,4240,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4292 = AOP-u 4240  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4185,1) == suma_liste(iopk,[4007,4032,4056,4080,4104,4129,4154],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4185 = AOP-u (4007 + 4032 + 4056 + 4080 + 4104 + 4129 + 4154)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4293,1) == suma_liste(iopk,[4216,4241,4266],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4293 = AOP-u (4216 + 4241 + 4266)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4186,1) == suma_liste(iopk,[4008,4033,4057,4081,4105,4130,4155],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4186 = AOP-u (4008 + 4033 + 4057 + 4081 + 4105 + 4130 + 4155)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4294,1) == suma_liste(iopk,[4217,4242,4267],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4294 = AOP-u (4217 + 4242 + 4267)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4187,1) == aop(iopk,4156,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4187 = AOP-u 4156  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4188,1) == aop(iopk,4157,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4188 = AOP-u 4157  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4189,1) == suma_liste(iopk,[4009,4034,4058,4082,4106,4131,4158],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4189 = AOP-u (4009 + 4034 + 4058 + 4082 + 4106 + 4131 + 4158)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4295,1) == suma_liste(iopk,[4218,4243,4268],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4295 = AOP-u (4218 + 4243 + 4268)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4190,1) == suma_liste(iopk,[4010,4035,4059,4083,4107,4132,4159],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4190 = AOP-u (4010 + 4035 + 4059 + 4083 + 4107 + 4132 + 4159)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4296,1) == suma_liste(iopk,[4219,4244,4269],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4296 = AOP-u (4219 + 4244 + 4269)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4011,1) == suma_liste(iopk,[4005,4006,4007,4009],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4011 = AOP-u (4005 + 4006 + 4007 + 4009)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4012,1) == aop(iopk,4008,1) + aop(iopk,4010,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4012 = AOP-u (4008 + 4010)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4036,1) == suma_liste(iopk,[4031,4032,4034],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4036 = AOP-u (4031 + 4032 + 4034)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4037,1) == aop(iopk,4033,1) + aop(iopk,4035,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4037 = AOP-u (4033 + 4035)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4060,1) == suma_liste(iopk,[4055,4056,4058],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4060 = AOP-u (4055 + 4056 + 4058)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4061,1) == aop(iopk,4057,1) + aop(iopk,4059,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4061 = AOP-u (4057 + 4059)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4084,1) == suma_liste(iopk,[4079,4080,4082],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4084 = AOP-u (4079 + 4080 + 4082)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4085,1) == aop(iopk,4081,1) + aop(iopk,4083,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4085 = AOP-u (4081 + 4083)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4108,1) == suma_liste(iopk,[4103,4104,4106],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4108 = AOP-u (4103 + 4104 + 4106)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4109,1) == aop(iopk,4105,1) + aop(iopk,4107,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4109 = AOP-u (4105 + 4107)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4133,1) == suma_liste(iopk,[4127,4129,4131],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4133 = AOP-u (4127 + 4129 + 4131)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4134,1) == suma_liste(iopk,[4128,4130,4132],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4134 = AOP-u (4128 + 4130 + 4132)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4160,1) == suma_liste(iopk,[4153,4154,4158],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4160 = AOP-u (4153 + 4154 + 4158)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4161,1) == suma_liste(iopk,[4155,4156,4157,4159],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4161 = AOP-u (4155 + 4156 + 4157 + 4159)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4191,1) == suma_liste(iopk,[4181,4182,4184,4185,4189],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4191 = AOP-u (4181 + 4182 + 4184 + 4185 + 4189)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4192,1) == suma_liste(iopk,[4183,4186,4187,4188,4190],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4192 = AOP-u (4183 + 4186 + 4187 + 4188 + 4190)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4191,1) == suma_liste(iopk,[4011,4036,4060,4084,4108,4133,4160],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4191 = AOP-u (4011 + 4036 + 4060 + 4084 + 4108 + 4133 + 4160)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4192,1) == suma_liste(iopk,[4012,4037,4061,4085,4109,4134,4161],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4192 = AOP-u (4012 + 4037 + 4061 + 4085 + 4109 + 4134 + 4161)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4220,1) == suma_liste(iopk,[4215,4216,4218],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4220 = AOP-u (4215 + 4216 + 4218)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4221,1) == aop(iopk,4217,1) + aop(iopk,4219,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4221 = AOP-u (4217 + 4219)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4245,1) == suma_liste(iopk,[4239,4241,4243],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4245 = AOP-u (4239 + 4241 + 4243)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4246,1) == suma_liste(iopk,[4240,4242,4244],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4246 = AOP-u (4240 + 4242 + 4244)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4270,1) == suma_liste(iopk,[4265,4266,4268],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4270 = AOP-u (4265 + 4266 + 4268)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4271,1) == aop(iopk,4267,1) + aop(iopk,4269,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4271 = AOP-u (4267 + 4269)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4297,1) == suma_liste(iopk,[4289,4290,4291,4293,4295],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4297 = AOP-u (4289 + 4290 + 4291 + 4293 + 4295)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4298,1) == suma_liste(iopk,[4292,4294,4296],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4298 = AOP-u (4292 + 4294 + 4296)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4297,1) == suma_liste(iopk,[4220,4245,4270],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4297 = AOP-u (4220 + 4245 + 4270)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4298,1) == suma_liste(iopk,[4221,4246,4271],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4298 = AOP-u (4221 + 4246 + 4271)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4330,1) == suma_liste(iopk,[4325,4326,4328],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4330 = AOP-u (4325 + 4326 + 4328)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4331,1) == aop(iopk,4327,1) + aop(iopk,4329,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4331 = AOP-u (4327 + 4329)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4013,1) == suma_liste(iopk,[4004,4011],1)-aop(iopk,4012,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4013 = AOP-u (4004 + 4011 - 4012)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4038,1) == suma_liste(iopk,[4030,4036],1)-aop(iopk,4037,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4038 = AOP-u (4030 + 4036 - 4037)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4062,1) == suma_liste(iopk,[4054,4060],1)-aop(iopk,4061,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4062 = AOP-u (4054 + 4060 - 4061)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4086,1) == suma_liste(iopk,[4078,4084],1)-aop(iopk,4085,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4086 = AOP-u (4078 + 4084 - 4085)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4110,1) == suma_liste(iopk,[4102,4108],1)-aop(iopk,4109,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4110 = AOP-u (4102 + 4108 - 4109)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4135,1) == suma_liste(iopk,[4126,4133],1)-aop(iopk,4134,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4135 = AOP-u (4126 + 4133 - 4134)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4162,1) == suma_liste(iopk,[4152,4160],1)-aop(iopk,4161,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4162 = AOP-u (4152 + 4160 - 4161)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4193,1) == suma_liste(iopk,[4180,4191],1)-aop(iopk,4192,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4193 = AOP-u (4180 + 4191 - 4192)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4222,1) == suma_liste(iopk,[4214,4220],1)-aop(iopk,4221,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4222 = AOP-u (4214 + 4220 - 4221)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4247,1) == suma_liste(iopk,[4238,4245],1)-aop(iopk,4246,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4247 = AOP-u (4238 + 4245 - 4246)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4272,1) == suma_liste(iopk,[4264,4270],1)-aop(iopk,4271,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4272 = AOP-u (4264 + 4270 - 4271)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4299,1) == suma_liste(iopk,[4288,4297],1)-aop(iopk,4298,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4299 = AOP-u (4288 + 4297 - 4298)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4332,1) == suma_liste(iopk,[4324,4330],1)-aop(iopk,4331,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4332 = AOP-u (4324 + 4330 - 4331)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4193,1) == suma_liste(iopk,[4013,4038,4062,4086,4110,4135,4162],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4193 = AOP-u (4013 + 4038 + 4062 + 4086 + 4110 + 4135 + 4162)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4299,1) == suma_liste(iopk,[4222,4247,4272],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4299 = AOP-u (4222 + 4247 + 4272)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4317,1) == aop(iopk,4193,1) - aop(iopk,4299,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4317 = AOP-u (4193 - 4299)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4317,1) > 0 ):
            if not( aop(iopk,4332,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4317 > 0, onda je AOP 4332 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4332,1) > 0 ):
            if not( aop(iopk,4317,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4332 > 0, onda je AOP 4317 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4014,1) == aop(iopk,4013,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4014 = AOP-u 4013  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4039,1) == aop(iopk,4038,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4039 = AOP-u 4038  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4063,1) == aop(iopk,4062,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4063 = AOP-u 4062  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4111,1) == aop(iopk,4110,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4111 = AOP-u 4110  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4163,1) == aop(iopk,4162,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4163 = AOP-u 4162  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4194,1) == aop(iopk,4193,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4194 = AOP-u 4193  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4223,1) == aop(iopk,4222,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4223 = AOP-u 4222  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4248,1) == aop(iopk,4247,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4248 = AOP-u 4247  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4273,1) == aop(iopk,4272,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4273 = AOP-u 4272  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4300,1) == aop(iopk,4299,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4300 = AOP-u 4299  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4318,1) == aop(iopk,4317,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4318 = AOP-u 4317  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4333,1) == aop(iopk,4332,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4333 = AOP-u 4332  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4017,1) == suma(iopk,4014,4015,1)-aop(iopk,4016,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4017 = AOP-u (4014 + 4015 - 4016)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4042,1) == suma(iopk,4039,4040,1)-aop(iopk,4041,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4042 = AOP-u (4039 + 4040 - 4041)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4066,1) == suma(iopk,4063,4064,1)-aop(iopk,4065,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4066 = AOP-u (4063 + 4064 - 4065)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4114,1) == suma(iopk,4111,4112,1)-aop(iopk,4113,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4114 = AOP-u (4111 + 4112 - 4113)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4139,1) == suma(iopk,4136,4137,1)-aop(iopk,4138,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4139 = AOP-u (4136 + 4137 - 4138)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4166,1) == suma(iopk,4163,4164,1)-aop(iopk,4165,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4166 = AOP-u (4163 + 4164 - 4165)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4197,1) == suma(iopk,4194,4195,1)-aop(iopk,4196,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4197 = AOP-u (4194 + 4195 - 4196)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4226,1) == suma(iopk,4223,4224,1)-aop(iopk,4225,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4226 = AOP-u (4223 + 4224 - 4225)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4251,1) == suma(iopk,4248,4249,1)-aop(iopk,4250,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4251 = AOP-u (4248 + 4249 - 4250)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4276,1) == suma(iopk,4273,4274,1)-aop(iopk,4275,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4276 = AOP-u (4273 + 4274 - 4275)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4303,1) == suma(iopk,4300,4301,1)-aop(iopk,4302,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4303 = AOP-u (4300 + 4301 - 4302)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4336,1) == suma(iopk,4333,4334,1)-aop(iopk,4335,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4336 = AOP-u (4333 + 4334 - 4335)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4195,1) == suma_liste(iopk,[4015,4040,4064,4088,4112,4137,4164],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4195 = AOP-u (4015 + 4040 + 4064 + 4088 + 4112 + 4137 + 4164)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4196,1) == suma_liste(iopk,[4016,4041,4065,4089,4113,4138,4165],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4196 = AOP-u (4016 + 4041 + 4065 + 4089 + 4113 + 4138 + 4165)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4197,1) == suma_liste(iopk,[4017,4042,4066,4090,4114,4139,4166],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4197 = AOP-u (4017 + 4042 + 4066 + 4090 + 4114 + 4139 + 4166)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4301,1) == suma_liste(iopk,[4224,4249,4274],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4301 = AOP-u (4224 + 4249 + 4274)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4302,1) == suma_liste(iopk,[4225,4250,4275],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4302 = AOP-u (4225 + 4250 + 4275)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4303,1) == suma_liste(iopk,[4226,4251,4276],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4303 = AOP-u (4226 + 4251 + 4276)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4319,1) == aop(iopk,4197,1) - aop(iopk,4303,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4319 = AOP-u (4197 - 4303)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4319,1) > 0 ):
            if not( aop(iopk,4336,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4319 > 0, onda je AOP 4336 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4336,1) > 0 ):
            if not( aop(iopk,4319,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4336 > 0, onda je AOP 4319 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4198,1) == suma_liste(iopk,[4018,4067,4091],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4198 = AOP-u (4018 + 4067 + 4091)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4199,1) == aop(iopk,4140,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4199 = AOP-u 4140  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4200,1) == aop(iopk,4141,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4200 = AOP-u 4141  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4304,1) == aop(iopk,4277,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4304 = AOP-u 4277  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4201,1) == suma_liste(iopk,[4019,4043,4115,4167],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4201 = AOP-u (4019 + 4043 + 4115 + 4167)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4305,1) == aop(iopk,4227,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4305 = AOP-u 4227  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4306,1) == aop(iopk,4252,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4306 = AOP-u 4252  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4307,1) == aop(iopk,4253,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4307 = AOP-u 4253  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4202,1) == suma_liste(iopk,[4020,4044,4068,4092,4116,4142,4168],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4202 = AOP-u (4020 + 4044 + 4068 + 4092 + 4116 + 4142 + 4168)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4308,1) == suma_liste(iopk,[4228,4254,4278],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4308 = AOP-u (4228 + 4254 + 4278)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4203,1) == suma_liste(iopk,[4021,4045,4069,4093,4117,4143,4169],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4203 = AOP-u (4021 + 4045 + 4069 + 4093 + 4117 + 4143 + 4169)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4309,1) == suma_liste(iopk,[4229,4255,4279],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4309 = AOP-u (4229 + 4255 + 4279)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4204,1) == aop(iopk,4170,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4204 = AOP-u 4170  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4205,1) == aop(iopk,4171,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4205 = AOP-u 4171  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4206,1) == suma_liste(iopk,[4022,4046,4070,4094,4118,4144,4172],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4206 = AOP-u (4022 + 4046 + 4070 + 4094 + 4118 + 4144 + 4172)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4310,1) == suma_liste(iopk,[4230,4256,4280],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4310 = AOP-u (4230 + 4256 + 4280)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4207,1) == suma_liste(iopk,[4023,4047,4071,4095,4119,4145,4173],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4207 = AOP-u (4023 + 4047 + 4071 + 4095 + 4119 + 4145 + 4173)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4311,1) == suma_liste(iopk,[4231,4257,4281],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4311 = AOP-u (4231 + 4257 + 4281)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4024,1) == suma_liste(iopk,[4018,4019,4020,4022],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4024 = AOP-u (4018 + 4019 + 4020 + 4022)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4025,1) == aop(iopk,4021,1) + aop(iopk,4023,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4025 = AOP-u (4021 + 4023)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4048,1) == suma_liste(iopk,[4043,4044,4046],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4048 = AOP-u (4043 + 4044 + 4046)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4049,1) == aop(iopk,4045,1) + aop(iopk,4047,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4049 = AOP-u (4045 + 4047)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4072,1) == suma_liste(iopk,[4067,4068,4070],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4072 = AOP-u (4067 + 4068 + 4070)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4073,1) == aop(iopk,4069,1) + aop(iopk,4071,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4073 = AOP-u (4069 + 4071)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4096,1) == suma_liste(iopk,[4091,4092,4094],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4096 = AOP-u (4091 + 4092 + 4094)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4097,1) == aop(iopk,4093,1) + aop(iopk,4095,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4097 = AOP-u (4093 + 4095)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4120,1) == suma_liste(iopk,[4115,4116,4118],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4120 = AOP-u (4115 + 4116 + 4118)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4121,1) == aop(iopk,4117,1) + aop(iopk,4119,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4121 = AOP-u (4117 + 4119)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4146,1) == suma_liste(iopk,[4140,4142,4144],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4146 = AOP-u (4140 + 4142 + 4144)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4147,1) == suma_liste(iopk,[4141,4143,4145],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4147 = AOP-u (4141 + 4143 + 4145)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4174,1) == suma_liste(iopk,[4167,4168,4172],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4174 = AOP-u (4167 + 4168 + 4172)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4175,1) == suma_liste(iopk,[4169,4170,4171,4173],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4175 = AOP-u (4169 + 4170 + 4171 + 4173)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4208,1) == suma_liste(iopk,[4198,4199,4201,4202,4206],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4208 = AOP-u (4198 + 4199 + 4201 + 4202 + 4206)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4209,1) == suma_liste(iopk,[4200,4203,4204,4205,4207],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4209 = AOP-u (4200 + 4203 + 4204 + 4205 + 4207)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4208,1) == suma_liste(iopk,[4024,4048,4072,4096,4120,4146,4174],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4208 = AOP-u (4024 + 4048 + 4072 + 4096 + 4120 + 4146 + 4174)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4209,1) == suma_liste(iopk,[4025,4049,4073,4097,4121,4147,4175],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4209 = AOP-u (4025 + 4049 + 4073 + 4097 + 4121 + 4147 + 4175)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4232,1) == suma_liste(iopk,[4227,4228,4230],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4232 = AOP-u (4227 + 4228 + 4230)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4233,1) == aop(iopk,4229,1) + aop(iopk,4231,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4233 = AOP-u (4229 + 4231)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4258,1) == suma_liste(iopk,[4252,4254,4256],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4258 = AOP-u (4252 + 4254 + 4256)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4259,1) == suma_liste(iopk,[4253,4255,4257],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4259 = AOP-u (4253 + 4255 + 4257)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4282,1) == suma_liste(iopk,[4277,4278,4280],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4282 = AOP-u (4277 + 4278 + 4280)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4283,1) == aop(iopk,4279,1) + aop(iopk,4281,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4283 = AOP-u (4279 + 4281)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4312,1) == suma_liste(iopk,[4304,4305,4306,4308,4310],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4312 = AOP-u (4304 + 4305 + 4306 + 4308 + 4310)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4313,1) == suma_liste(iopk,[4307,4309,4311],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4313 = AOP-u (4307 + 4309 + 4311)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4312,1) == suma_liste(iopk,[4232,4258,4282],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4312 = AOP-u (4232 + 4258 + 4282)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4313,1) == suma_liste(iopk,[4233,4259,4283],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4313 = AOP-u (4233 + 4259 + 4283)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4342,1) == suma_liste(iopk,[4337,4338,4340],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4342 = AOP-u (4337 + 4338 + 4340)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4343,1) == aop(iopk,4339,1) + aop(iopk,4341,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4343 = AOP-u (4339 + 4341)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4026,1) == suma_liste(iopk,[4017,4024],1)-aop(iopk,4025,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4026 = AOP-u (4017 + 4024 - 4025)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4050,1) == suma_liste(iopk,[4042,4048],1)-aop(iopk,4049,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4050 = AOP-u (4042 + 4048 - 4049)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4074,1) == suma_liste(iopk,[4066,4072],1)-aop(iopk,4073,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4074 = AOP-u (4066 + 4072 - 4073)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4098,1) == suma_liste(iopk,[4090,4096],1)-aop(iopk,4097,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4098 = AOP-u (4090 + 4096 - 4097)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4122,1) == suma_liste(iopk,[4114,4120],1)-aop(iopk,4121,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4122 = AOP-u (4114 + 4120 - 4121)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4148,1) == suma_liste(iopk,[4139,4146],1)-aop(iopk,4147,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4148 = AOP-u (4139 + 4146 - 4147)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4176,1) == suma_liste(iopk,[4166,4174],1)-aop(iopk,4175,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4176 = AOP-u (4166 + 4174 - 4175)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4210,1) == suma_liste(iopk,[4197,4208],1)-aop(iopk,4209,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4210 = AOP-u (4197 + 4208 - 4209)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4234,1) == suma_liste(iopk,[4226,4232],1)-aop(iopk,4233,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4234 = AOP-u (4226 + 4232 - 4233)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4260,1) == suma_liste(iopk,[4251,4258],1)-aop(iopk,4259,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4260 = AOP-u (4251 + 4258 - 4259)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4284,1) == suma_liste(iopk,[4276,4282],1)-aop(iopk,4283,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4284 = AOP-u (4276 + 4282 - 4283)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4314,1) == suma_liste(iopk,[4303,4312],1)-aop(iopk,4313,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4314 = AOP-u (4303 + 4312 - 4313)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4344,1) == suma_liste(iopk,[4336,4342],1)-aop(iopk,4343,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4344 = AOP-u (4336 + 4342 - 4343)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4210,1) == suma_liste(iopk,[4026,4050,4074,4098,4122,4148,4176],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4210 = AOP-u (4026 + 4050 + 4074 + 4098 + 4122 + 4148 + 4176)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4314,1) == suma_liste(iopk,[4234,4260,4284],1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4314 = AOP-u (4234 + 4260 + 4284)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4320,1) == aop(iopk,4210,1) - aop(iopk,4314,1) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4320 = AOP-u (4210 - 4314)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4320,1) > 0 ):
            if not( aop(iopk,4344,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4320 > 0, onda je AOP 4344 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if( aop(iopk,4344,1) > 0 ):
            if not( aop(iopk,4320,1) == 0 ):
                ...
                dzbir =  0 
                razlika = lzbir - dzbir
                form_errors.append('Ako je AOP 4344 > 0, onda je AOP 4320 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i gubitak iznad visine kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4054,1) == aop(bs,407,7) ):
            ...
            dzbir =  aop(bs,407,7) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4054 = AOP-u 0407 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4078,1) == aop(bs,409,7) ):
            ...
            dzbir =  aop(bs,409,7) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4078 = AOP-u 0409 kol. 7 bilans stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4102,1) == aop(bs,410,7) ):
            ...
            dzbir =  aop(bs,410,7) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4102 = AOP-u 0410 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4126,1) == suma(bs,411,412,7) ):
            ...
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4126 = AOP-u (0411 + 0412) kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4152,1) == aop(bs,414,7) ):
            ...
            dzbir =  aop(bs,414,7) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4152 = AOP-u 0414 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4214,1) == aop(bs,417,7) ):
            ...
            dzbir =  aop(bs,417,7) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4214 = AOP-u 0417 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4238,1) == aop(bs,420,7) ):
            ...
            dzbir =  aop(bs,420,7) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4238 = AOP-u 0420 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4264,1) == aop(bs,413,7) ):
            ...
            dzbir =  aop(bs,413,7) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4264 = AOP-u 0413 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4316,1) == aop(bs,401,7) ):
            ...
            dzbir =  aop(bs,401,7) 
            razlika = lzbir - dzbir
            form_warnings.append('AOP 4316 = AOP-u 0401 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo primenjuju obveznici koji vrše reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4013,1) + aop(iopk,4038,1) == suma_liste(bs,[402,421],6) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (4013 + 4038) = AOP-u (0402 + 0421) kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4062,1) == aop(bs,407,6) ):
            ...
            dzbir =  aop(bs,407,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4062 = AOP-u 0407 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4086,1) == aop(bs,409,6) ):
            ...
            dzbir =  aop(bs,409,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4086 = AOP-u 0409 kol. 6 bilans stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4110,1) == aop(bs,410,6) ):
            ...
            dzbir =  aop(bs,410,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4110 = AOP-u 0410 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4135,1) == suma(bs,411,412,6) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4135 = AOP-u (0411 + 0412) kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4162,1) == aop(bs,414,6) ):
            ...
            dzbir =  aop(bs,414,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4162 = AOP-u 0414 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4222,1) == aop(bs,417,6) ):
            ...
            dzbir =  aop(bs,417,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4222 = AOP-u 0417 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4247,1) == aop(bs,420,6) ):
            ...
            dzbir =  aop(bs,420,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4247 = AOP-u 0420 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4272,1) == aop(bs,413,6) ):
            ...
            dzbir =  aop(bs,413,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4272 = AOP-u 0413 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4317,1) == aop(bs,401,6) ):
            ...
            dzbir =  aop(bs,401,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4317 = AOP-u 0401 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4332,1) == aop(bs,458,6) ):
            ...
            dzbir =  aop(bs,458,6) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4332 = AOP-u 0458 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4026,1) + aop(iopk,4050,1) == suma_liste(bs,[402,421],5) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP (4026 + 4050) = AOP-u (0402 + 0421) kol. 5 bilans stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4074,1) == aop(bs,407,5) ):
            ...
            dzbir =  aop(bs,407,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4074 = AOP-u 0407 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4098,1) == aop(bs,409,5) ):
            ...
            dzbir =  aop(bs,409,5)
            razlika = lzbir - dzbir
            form_errors.append('AOP 4098 = AOP-u 0409 kol. 5 bilans stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4122,1) == aop(bs,410,5) ):
            ...
            dzbir =  aop(bs,410,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4122 = AOP-u 0410 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4148,1) == suma(bs,411,412,5) ):
            ...
            razlika = lzbir - dzbir
            form_errors.append('AOP 4148 = AOP-u (0411 + 0412) kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4176,1) == aop(bs,414,5) ):
            ...
            dzbir =  aop(bs,414,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4176 = AOP-u 0414 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4234,1) == aop(bs,417,5) ):
            ...
            dzbir =  aop(bs,417,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4234 = AOP-u 0417 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4260,1) == aop(bs,420,5) ):
            ...
            dzbir =  aop(bs,420,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4260 = AOP-u 0420 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4284,1) == aop(bs,413,5) ):
            ...
            dzbir =  aop(bs,413,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4284 = AOP-u 0413 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4320,1) == aop(bs,401,5) ):
            ...
            dzbir =  aop(bs,401,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4320 = AOP-u 0401 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( aop(iopk,4344,1) == aop(bs,458,5) ):
            ...
            dzbir =  aop(bs,458,5) 
            razlika = lzbir - dzbir
            form_errors.append('AOP 4344 = AOP-u 0458 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') ')
        ...
        if not( 2 <= aop(pp,10001,1) and 4 >= aop(pp, 10001, 1)  ):
            form_errors.append(' Oznaka za veličinu mora biti  2, 3  ili 4 ')
        
        #100003
        if not( aop(pp,10002,1) >= 0 ):
            form_errors.append(' Podatak o prosečnom broju zaposlenih u tekućoj godini mora biti upisan; ako nema zaposlenih upisuje se broj 0 ')
        ...
        for x in range (10100, 10300):
            if validiraj_spisak_pravnih_lica_obuhvacenih_konsolidacijom( x, aop(pps,x,2), aop(pps,x,3), aop(pps,x,4), aop(pps,x,5)) == False:
                ...
                form_errors.append('Na spisak pravnih lica koja su obuhvaćena konsolidacijom mora biti uneto bar jedno pravno lice Na spisak pravnih lica koja su obuhvaćena konsolidacijom niste uneli nijedan podatak ')
        
        #100013
        for x in range (10100, 10300):
            if aop(pps,x,5) == Zahtev.ObveznikInfo.MaticniBroj: 
                form_errors.append('Matično pravno lice ne može biti na spisku pravnih lica koja su obuhvaćena konsolidacijom Matično pravno lice ne može biti na spisku pravnih lica koja su obuhvaćena konsolidacijom ')
        
        #100014
        for x in range (10100, 10300):
            if validiraj_spisak_pravnih_lica_obuhvacenih_konsolidacijom( x, aop(pps,x,2), aop(pps,x,3), aop(pps,x,4), aop(pps,x,5)) == False: 
                form_errors.append('Za domaće pravno lice obveznik mora da unese matični broj, poslovno ime i sedište, a za strano pravno lice poslovno ime, državu i sedište Za domaće pravno lice unesite  matični broj, poslovno ime i sedište. Za strano pravno lice unesite poslovno ime, državu i sedište ')
        ...
        for x in range (10100, 10300):
            for y in range (x, 10300):
                if len(aop(pps,x,5)) != 0 and x != y and aop(pps,x,5) == aop(pps,y,5):
                    imaDuplikate = True
        if imaDuplikate:
            form_errors.append('Na spisku ne sme da se pojavi dva puta isto pravno lice Na spisak pravnih lica koja su obuhvaćena konsolidacijom uneli ste duplikate matičnih brojeva ')
        
        #100016
        for x in range (10100, 10300):
            if (aop(ppsnum, x, 1)!=0):
                if not (aop(ppsnum, x, 1)==(x-10099)): 
                    form_errors.append('Redni broj na spisku mora biti unet po rastućem redosledu Na spisku pravnih lica koja su obuhvaćena konsolidacijom u koloni "Redni broj" podatak nije unet po rastućem redosledu ')
        
        #100017
        for x in range(10100, 10300):
            if(aop(ppsnum, x, 1)==0):
                if( x != 10299 and aop(ppsnum, x+1,1)!=0 ):
                    form_errors.append('Obveznik ne sme da ostavi prazan red između pravilno unetih rednih brojeva Na spisku pravnih lica koja su obuhvaćena konsolidacijom  potrebno je popuniti kolonu "redni broj" po rastućem redosledu brojeva bez preskakanja redova ')
        
        #100018
        for x in range (10100, 10300):
            if (aop(ppsnum, x, 1) == 0):
                if (validiraj_spisak_pravnih_lica( x, aop(pps,x,2), aop(pps,x,3), aop(pps,x,4), aop(pps,x,5))): 
                    form_errors.append('Na spisku pravnih lica koja su obuhvaćena konsolidacijom obveznik mora uneti redni broj ukoliko je popunio podatke o zavisnom pravnom licu Na spisku pravnih lica koja su obuhvaćena konsolidacijom obveznik mora uneti redni broj ukoliko je popunio podatke o zavisnom pravnom licu ')
        
        #100019
        for x in range (10100, 10300):
            if (aop(ppsnum, x, 1) != 0 ):
                if (validiraj_spisak_pravnih_lica( x, aop(pps,x,2), aop(pps,x,3), aop(pps,x,4), aop(pps,x,5))==False): 
                    form_errors.append('Na spisku pravnih lica koja su obuhvaćena konsolidacijom obveznik mora uneti podatke o zavisnom pravnom licu  ukoliko je dodao redni broj  Na spisku pravnih lica koja su obuhvaćena konsolidacijom obveznik mora uneti podatke o zavisnom pravnom licu  ukoliko je dodao redni broj  ')
