    ...
    try:
       ...
       #Provera da li lice odgovorno za potpisivanje
        ...
        if not(proveriNapomene(bsNapomene, 1, 18, 4) or proveriNapomene(bsNapomene, 401, 422, 4) or proveriNapomene(buNapomene, 1001, 1042, 4) or proveriNapomene(ioorNapomene, 2001, 2022, 4)):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  =" Na AOP-u (0001 do 0018) + (0401 do 0422) bilansa stanja + (1001 do 1042)  bilansa uspeha + (2001 do 2022) izveštaja o ostalom rezultatu u koloni 4 (Broj napomene) mora biti unet bar jedan karakter. Potrebno je popuniti kolonu 4 u skladu sa oznakama iz Napomena uz finansijske izveštaje"
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Bilans uspeha'
        ...
        if not( suma(bs,1,18,5)+suma(bs,401,422,5) > 0 ): 
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='Zbir podataka na oznakama za AOP (0001 do 0018) kol. 5  + (0401 do 0422) kol. 5 ˃ 0 Bilans stanja mora imati iskazane podatke za tekući izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(bs,1,18,6)+suma(bs,401,422,6) > 0 ): 
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='Zbir podataka na oznakama za AOP (0001 do 0018) kol. 6 + (0401 do 0422) kol. 6 ˃ 0 Bilans stanja mora imati iskazane podatke za prethodni izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(bs,1,18,7)+suma(bs,401,422,7) > 0 ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='Zbir podataka na oznakama za AOP (0001 do 0018) kol. 7 + (0401 do 0422) kol. 7 ˃ 0 Bilans stanja, po pravilu,  mora imati iskazano početno stanje za prethodni izveštajni period kada Narodna banka Srbije vrši reklasifikaciju; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
        ...
        if not( aop(bs,18,5) == suma(bs,1,17,5) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0018 kol. 5 = zbiru AOP-a (0001 do 0017) kol. 5   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,18,6) == suma(bs,1,17,6) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0018 kol. 6 = zbiru AOP-a (0001 do 0017) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,18,7) == suma(bs,1,17,7) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0018 kol. 7 = zbiru AOP-a (0001 do 0017) kol. 7  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,414,5) == suma(bs,401,413,5) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0414 kol. 5 = zbiru AOP-a (0401 do 0413) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,414,6) == suma(bs,401,413,6) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0414 kol. 6 = zbiru AOP-a (0401 do 0413) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,414,7) == suma(bs,401,413,7) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0414 kol. 7 = zbiru AOP-a (0401 do 0413) kol. 7  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,416,5) > 0 ):
            if not( aop(bs,417,5) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0416 kol. 5 > 0, onda je AOP 0417 kol. 5 = 0 Ne mogu biti istovremeno prikazani dugovni i potražni saldo računa '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,417,5) > 0 ):
            if not( aop(bs,416,5) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je  AOP 0417 kol. 5 > 0, onda je AOP 0416 kol. 5 = 0 Ne mogu biti istovremeno prikazani dugovni i potražni saldo računa '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,416,6) > 0 ):
            if not( aop(bs,417,6) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0416 kol. 6 > 0, onda je AOP 0417 kol. 6 = 0 Ne mogu biti istovremeno prikazani dugovni i potražni saldo računa '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,417,6) > 0 ):
            if not( aop(bs,416,6) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0417 kol. 6 > 0, onda je AOP 0416 kol. 6 = 0 Ne mogu biti istovremeno prikazani dugovni i potražni saldo računa '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,416,7) > 0 ):
            if not( aop(bs,417,7) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0416 kol. 7 > 0, onda je AOP 0417 kol. 7 = 0 Ne mogu biti istovremeno prikazani dugovni i potražni saldo računa '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,417,7) > 0 ):
            if not( aop(bs,416,7) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0417 kol. 7 > 0, onda je AOP 0416 kol. 7 = 0 Ne mogu biti istovremeno prikazani dugovni i potražni saldo računa '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(bs,[415,416,418],5) > suma_liste(bs,[417,419],5) ):
            if not( aop(bs,420,5) == suma_liste(bs,[415,416,418],5)-suma_liste(bs,[417,419],5) ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='AOP 0420 kol. 5 = AOP-u (0415 + 0416 - 0417 + 0418 - 0419) kol. 5, ako je AOP (0415 + 0416 + 0418) kol. 5 > AOP-a (0417 + 0419) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(bs,[415,416,418],6) > suma_liste(bs,[417,419],6) ):
            if not( aop(bs,420,6) == suma_liste(bs,[415,416,418],6)-suma_liste(bs,[417,419],6) ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='AOP 0420 kol. 6 = AOP-u (0415 + 0416 - 0417 + 0418 - 0419) kol. 6, ako je AOP (0415 + 0416 + 0418) kol. 6 > AOP-a (0417 + 0419) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(bs,[415,416,418],7) > suma_liste(bs,[417,419],7) ):
            if not( aop(bs,420,7) == suma_liste(bs,[415,416,418],7)-suma_liste(bs,[417,419],7) ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='AOP 0420 kol. 7 = AOP-u (0415 + 0416 - 0417 + 0418 - 0419) kol. 7, ako je AOP (0415 + 0416 + 0418) kol. 7 > AOP-a (0417 + 0419) kol. 7  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(bs,[415,416,418],5) < suma_liste(bs,[417,419],5) ):
            if not( aop(bs,421,5) == suma_liste(bs,[417,419],5)-suma_liste(bs,[415,416,418],5) ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='AOP 0421 kol. 5 = AOP-u (0417 - 0415 - 0416 - 0418 + 0419) kol. 5, ako je AOP (0415 + 0416 + 0418) kol. 5 < AOP-a (0417 + 0419) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(bs,[415,416,418],6) < suma_liste(bs,[417,419],6) ):
            if not( aop(bs,421,6) == suma_liste(bs,[417,419],6)-suma_liste(bs,[415,416,418],6) ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='AOP 0421 kol. 6 = AOP-u (0417 - 0415 - 0416 - 0418 + 0419) kol. 6, ako je AOP (0415 + 0416 + 0418) kol. 6 < AOP-a (0417 + 0419) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(bs,[415,416,418],7) < suma_liste(bs,[417,419],7) ):
            if not( aop(bs,421,7) == suma_liste(bs,[417,419],7)-suma_liste(bs,[415,416,418],7) ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='AOP 0421 kol.7 = AOP-u (0417 - 0415 - 0416 - 0418 + 0419) kol.7, ako je AOP (0415 + 0416 + 0418) kol. 7 < AOP-a (0417 + 0419) kol. 7  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(bs,[415,416,418],5) == suma_liste(bs,[417,419],5) ):
            if not( suma(bs,420,421,5) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='AOP (0420 + 0421) kol. 5 = 0, ako je AOP (0415 + 0416 + 0418) kol. 5 = AOP-u (0417 + 0419) kol. 5 Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(bs,[415,416,418],6) == suma_liste(bs,[417,419],6) ):
            if not( suma(bs,420,421,6) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='AOP (0420 + 0421) kol. 6 = 0, ako je AOP (0415 + 0416 + 0418) kol. 6 = AOP-u (0417 + 0419) kol. 6 Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(bs,[415,416,418],7) == suma_liste(bs,[417,419],7) ):
            if not( suma(bs,420,421,7) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='AOP (0420 + 0421) kol. 7 = 0, ako je AOP (0415 + 0416 + 0418) kol. 7 = AOP-u (0417 + 0419) kol. 7 Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,420,5) > 0 ):
            if not( aop(bs,421,5) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0420 kol. 5 > 0, onda je AOP 0421 kol. 5 = 0 Ne mogu biti istovremeno prikazani ukupni kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,421,5) > 0 ):
            if not( aop(bs,420,5) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0421 kol. 5 > 0, onda je AOP 0420 kol. 5 = 0 Ne mogu biti istovremeno prikazani ukupni kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,420,6) > 0 ):
            if not( aop(bs,421,6) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0420 kol. 6 > 0, onda je AOP 0421 kol. 6 = 0 Ne mogu biti istovremeno prikazani ukupni kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,421,6) > 0 ):
            if not( aop(bs,420,6) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0421 kol. 6 > 0, onda je AOP 0420 kol. 6 = 0 Ne mogu biti istovremeno prikazani ukupni kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,420,7) > 0 ):
            if not( aop(bs,421,7) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0420 kol. 7 > 0, onda je AOP 0421 kol. 7 = 0 Ne mogu biti istovremeno prikazani ukupni kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bs,421,7) > 0 ):
            if not( aop(bs,420,7) == 0 ):
                ...
                naziv_obrasca='Bilans stanja'
                poruka  ='Ako je AOP 0421 kol. 7 > 0, onda je AOP 0420 kol. 7 = 0 Ne mogu biti istovremeno prikazani ukupni kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,422,5) == suma_liste(bs,[414,420],5)-aop(bs,421,5) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0422 kol. 5 = AOP-u (0414 + 0420 - 0421) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,422,6) == suma_liste(bs,[414,420],6)-aop(bs,421,6) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0422 kol. 6 = AOP-u (0414 + 0420 - 0421) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,422,7) == suma_liste(bs,[414,420],7)-aop(bs,421,7) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0422 kol. 7 = AOP-u (0414 + 0420 - 0421) kol. 7  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,18,5) == aop(bs,422,5) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0018 kol. 5 = AOP-u 0422 kol. 5 Kontrolno pravilo zahteva slaganje bilansne aktive i pasive '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,18,6) == aop(bs,422,6) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0018 kol. 6 = AOP-u 0422 kol. 6 Kontrolno pravilo zahteva slaganje bilansne aktive i pasive '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(bs,18,7) == aop(bs,422,7) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 0018 kol. 7 = AOP-u 0422 kol. 7 Kontrolno pravilo zahteva slaganje bilansne aktive i pasive '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(bu,1001,1042,5) > 0 ): 
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='Zbir podataka na oznakama za AOP (1001 do 1042) kol. 5 ˃ 0 Bilans uspeha mora imati iskazane podatke za tekući izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(bu,1001,1042,6) > 0 ): 
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='Zbir podataka na oznakama za AOP (1001 do 1042) kol. 6 ˃ 0 Bilans uspeha mora imati iskazane podatke za prethodni izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1003,5) > 0 ):
            if not( aop(bu,1004,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1003 kol. 5 > 0, onda je AOP 1004 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1004,5) > 0 ):
            if not( aop(bu,1003,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1004 kol. 5 > 0, onda je AOP 1003 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1003,6) > 0 ):
            if not( aop(bu,1004,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1003 kol. 6 > 0, onda je AOP 1004 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1004,6) > 0 ):
            if not( aop(bu,1003,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1004 kol. 6 > 0, onda je AOP 1003 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1007,5) > 0 ):
            if not( aop(bu,1008,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1007 kol. 5 > 0, onda je AOP 1008 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1008,5) > 0 ):
            if not( aop(bu,1007,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1008 kol. 5 > 0, onda je AOP 1007 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1007,6) > 0 ):
            if not( aop(bu,1008,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1007 kol. 6 > 0, onda je AOP 1008 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1008,6) > 0 ):
            if not( aop(bu,1007,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1008 kol. 6 > 0, onda je AOP 1007 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1017,5) > 0 ):
            if not( aop(bu,1018,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1017 kol. 5 > 0, onda je AOP 1018 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1018,5) > 0 ):
            if not( aop(bu,1017,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je  AOP 1018 kol. 5 > 0, onda je AOP 1017 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1017,6) > 0 ):
            if not( aop(bu,1018,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1017 kol. 6 > 0, onda je AOP 1018 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1018,6) > 0 ):
            if not( aop(bu,1017,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1018 kol. 6 > 0, onda je AOP 1017 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1019,5) > 0 ):
            if not( aop(bu,1020,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1019 kol. 5 > 0, onda je AOP 1020 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1020,5) > 0 ):
            if not( aop(bu,1019,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je  AOP 1020 kol. 5 > 0, onda je AOP 1019 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1019,6) > 0 ):
            if not( aop(bu,1020,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1019 kol. 6 > 0, onda je AOP 1020 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1020,6) > 0 ):
            if not( aop(bu,1019,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1020 kol. 6 > 0, onda je AOP 1019 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto dobitak i gubitak '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1021,5) > 0 ):
            if not( aop(bu,1022,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1021 kol. 5 > 0, onda je AOP 1022 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1022,5) > 0 ):
            if not( aop(bu,1021,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je  AOP 1022 kol. 5 > 0, onda je AOP 1021 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1021,6) > 0 ):
            if not( aop(bu,1022,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1021 kol. 6 > 0, onda je AOP 1022 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1022,6) > 0 ):
            if not( aop(bu,1021,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1022 kol. 6 > 0, onda je AOP 1021 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1023,5) > 0 ):
            if not( aop(bu,1024,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1023 kol. 5 > 0, onda je AOP 1024 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1024,5) > 0 ):
            if not( aop(bu,1023,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je  AOP 1024 kol. 5 > 0, onda je AOP 1023 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1023,6) > 0 ):
            if not( aop(bu,1024,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1023 kol. 6 > 0, onda je AOP 1024 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1024,6) > 0 ):
            if not( aop(bu,1023,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1024 kol. 6 > 0, onda je AOP 1023 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani neto prihod i rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1026,5) > 0 ):
            if not( aop(bu,1027,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1026 kol. 5 > 0, onda je AOP 1027 kol. 5 = 0  U Bilansu uspeha ne mogu biti istovremeno prikazani ukupan neto poslovni prihod i ukupan neto poslovni rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1027,5) > 0 ):
            if not( aop(bu,1026,5) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je  AOP 1027 kol. 5 > 0, onda je AOP 1026 kol. 5 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani ukupan neto poslovni prihod i ukupan neto poslovni rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1026,6) > 0 ):
            if not( aop(bu,1027,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je AOP 1026 kol. 6 > 0, onda je AOP 1027 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani ukupan neto poslovni prihod i ukupan neto poslovni rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(bu,1027,6) > 0 ):
            if not( aop(bu,1026,6) == 0 ):
                ...
                naziv_obrasca='Bilans uspeha'
                poruka  ='Ako je  AOP 1027 kol. 6 > 0, onda je AOP 1026 kol. 6 = 0 U Bilansu uspeha ne mogu biti istovremeno prikazani ukupan neto poslovni prihod i ukupan neto poslovni rashod '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( suma(ioor,2001,2022,5) > 0 ):
            ...
            naziv_obrasca='Izveštaj o ostalom rezultatu'
            poruka  ='Zbir podataka na oznakama za AOP (2001 do 2022) kol. 5 > 0 Izveštaj o ostalom rezultatu mora imati iskazane podatke za tekući izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(ioor,2001,2022,6) > 0 ):
            ...
            naziv_obrasca='Izveštaj o ostalom rezultatu'
            poruka  ='Zbir podataka na oznakama za AOP (2001 do 2022) kol. 6 > 0 Izveštaj o ostalom rezultatu mora imati iskazane podatke za prethodni izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017],5) > suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018],5) ):
            if not( aop(ioor,2019,5) == suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017],5)-suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018],5) ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='AOP 2019 kol. 5 = AOP-u (2003 - 2004 + 2005 - 2006 + 2007 - 2008 + 2009 - 2010 + 2011 - 2012 + 2013 - 2014 + 2015 - 2016 + 2017 - 2018) kol. 5, ako je AOP (2003 + 2005 + 2007 + 2009 + 2011 + 2013 + 2015 + 2017) kol. 5 > AOP-a (2004 + 2006 + 2008 + 2010 + 2012 + 2014 + 2016 + 2018) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017],6) > suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018],6) ):
            if not( aop(ioor,2019,6) == suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017],6)-suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018],6) ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='AOP 2019 kol. 6 = AOP-u (2003 - 2004 + 2005 - 2006 + 2007 - 2008 + 2009 - 2010 + 2011 - 2012 + 2013 - 2014 + 2015 - 2016 + 2017 - 2018) kol. 6, ako je AOP (2003 + 2005 + 2007 + 2009 + 2011 + 2013 + 2015 + 2017) kol. 6 > AOP-a (2004 + 2006 + 2008 + 2010 + 2012 + 2014 + 2016 + 2018) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017],5) < suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018],5) ):
            if not( aop(ioor,2020,5) == suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018],5)-suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017],5) ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='AOP 2020 kol. 5 = AOP-u (2004 - 2003 - 2005 + 2006 - 2007 + 2008 - 2009 + 2010 - 2011 + 2012 - 2013 + 2014 - 2015 + 2016 - 2017 + 2018) kol. 5, ako je AOP (2003 + 2005 + 2007 + 2009 + 2011 + 2013 + 2015 + 2017) kol. 5 < AOP-a (2004 + 2006 + 2008 + 2010 + 2012 + 2014 + 2016 + 2018) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017],6) < suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018],6) ):
            if not( aop(ioor,2020,6) == suma_liste(ioor,[2004,2006,2008,2010,2012,2014,2016,2018],6)-suma_liste(ioor,[2003,2005,2007,2009,2011,2013,2015,2017],6) ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='AOP 2020 kol. 6 = AOP-u (2004 - 2003 - 2005 + 2006 - 2007 + 2008 - 2009 + 2010 - 2011 + 2012 - 2013 + 2014 - 2015 + 2016 - 2017 + 2018) kol. 6, ako je AOP (2003 + 2005 + 2007 + 2009 + 2011 + 2013 + 2015 + 2017) kol. 6 < AOP-a (2004 + 2006 + 2008 + 2010 + 2012 + 2014 + 2016 + 2018) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(ioor,2019,5) > 0 ):
            if not( aop(ioor,2020,5) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='Ako je AOP 2019 kol. 5 > 0,onda je AOP 2020 kol. 5 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani ukupan pozitivan i  negativan ostali rezultat perioda '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(ioor,2020,5) > 0 ):
            if not( aop(ioor,2019,5) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='Ako je AOP 2020 kol. 5 > 0, onda je AOP 2019 kol. 5 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani ukupan pozitivan i  negativan ostali rezultat perioda '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(ioor,2019,6) > 0 ):
            if not( aop(ioor,2020,6) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='Ako je AOP 2019 kol. 6 > 0,onda je AOP 2020 kol. 6 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani ukupan pozitivan i  negativan ostali rezultat perioda '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(ioor,2020,6) > 0 ):
            if not( aop(ioor,2019,6) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='Ako je AOP 2020 kol. 6 > 0, onda je AOP 2019 kol. 6 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani ukupan pozitivan i  negativan ostali rezultat perioda '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(ioor,[2001,2019],5) < suma_liste(ioor,[2002,2020],5) ):
            if not( aop(ioor,2022,5) == suma_liste(ioor,[2002,2020],5)-suma_liste(ioor,[2001,2019],5) ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='AOP 2022 kol. 5 = AOP-u (2002 - 2001 - 2019 + 2020) kol. 5, ako je AOP (2001 + 2019) kol. 5 < AOP-a (2002 + 2020) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(ioor,[2001,2019],6) < suma_liste(ioor,[2002,2020],6) ):
            if not( aop(ioor,2022,6) == suma_liste(ioor,[2002,2020],6)-suma_liste(ioor,[2001,2019],6) ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='AOP 2022 kol. 6 = AOP-u (2002 - 2001 - 2019 + 2020) kol. 6, ako je AOP (2001 + 2019) kol. 6 < AOP-a (2002 + 2020) kol. 6  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(ioor,[2001,2019],5) == suma_liste(ioor,[2002,2020],5) ):
            if not( suma(ioor,2021,2022,5) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='AOP (2021 + 2022) kol. 5 = 0, ako je AOP (2001 + 2019) kol. 5 = AOP-u (2002 + 2020) kol. 5 Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(ioor,[2001,2019],6) == suma_liste(ioor,[2002,2020],6) ):
            if not( suma(ioor,2021,2022,6) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='AOP (2021 + 2022) kol. 6 = 0, ako je AOP (2001 + 2019) kol. 6 = AOP-u (2002 + 2020) kol. 6 Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(ioor,2021,5) > 0 ):
            if not( aop(ioor,2022,5) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='Ako je AOP 2021 kol. 5 > 0, onda je AOP 2022 kol. 5 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani ukupan pozitivan i negativan rezultat perioda '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(ioor,2022,5) > 0 ):
            if not( aop(ioor,2021,5) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='Ako je AOP 2022 kol. 5  > 0, onda je AOP 2021 kol. 5 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani ukupan pozitivan i negativan rezultat perioda '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(ioor,2021,6) > 0 ):
            if not( aop(ioor,2022,6) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='Ako je AOP 2021 kol. 6 > 0, onda je AOP 2022 kol. 6 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani ukupan pozitivan i negativan rezultat perioda '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(ioor,2022,6) > 0 ):
            if not( aop(ioor,2021,6) == 0 ):
                ...
                naziv_obrasca='Izveštaj o ostalom rezultatu'
                poruka  ='Ako je AOP 2022 kol. 6  > 0, onda je AOP 2021 kol. 6 = 0 U Izveštaju o ostalom rezultatu ne mogu biti istovremeno prikazani ukupan pozitivan i negativan rezultat perioda '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(ioor,[2001,2019,2022],5) == suma_liste(ioor,[2002,2020,2021],5) ):
            ...
            naziv_obrasca='Izveštaj o ostalom rezultatu'
            poruka  ='AOP (2001 + 2019 + 2022) kol. 5 = AOP-u (2002 + 2020 + 2021) kol. 5 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(ioor,[2001,2019,2022],6) == suma_liste(ioor,[2002,2020,2021],6) ):
            ...
            naziv_obrasca='Izveštaj o ostalom rezultatu'
            poruka  ='AOP (2001 + 2019 + 2022) kol. 6 = AOP-u (2002 + 2020 + 2021) kol. 6 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(iotg,3001,3063,3) > 0 ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='Zbir podataka na oznakama za AOP (3001 do 3063) kol. 3 > 0 Izveštaj o tokovima gotovine mora imati iskazane podatke za tekući izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(iotg,3001,3063,4) > 0 ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='Zbir podataka na oznakama za AOP (3001 do 3063) kol. 4 > 0 Izveštaj o tokovima gotovine mora imati iskazane podatke za prethodni izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3006,3) == suma(iotg,3007,3009,3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3006 kol. 3 = AOP-u (3007 + 3008 + 3009) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3006,4) == suma(iotg,3007,3009,4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3006 kol. 4 = AOP-u (3007 + 3008 + 3009) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3001,3) > aop(iotg,3006,3) ):
            if not( aop(iotg,3010,3) == aop(iotg,3001,3)-aop(iotg,3006,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  =' AOP 3010 kol. 3 = AOP-u (3001 - 3006) kol. 3, ako je AOP 3001 kol. 3 > AOP-a 3006 kol. 3   '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3001,4) > aop(iotg,3006,4) ):
            if not( aop(iotg,3010,4) == aop(iotg,3001,4)-aop(iotg,3006,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  =' AOP 3010 kol. 4 = AOP-u (3001 - 3006) kol. 4, ako je AOP 3001 kol. 4 > AOP-a 3006 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3001,3) < aop(iotg,3006,3) ):
            if not( aop(iotg,3011,3) == aop(iotg,3006,3)-aop(iotg,3001,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3011 kol. 3 = AOP-u (3006 - 3001) kol. 3 , ako je AOP 3001 kol. 3 < AOP-a 3006 kol. 3    '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3001,4) < aop(iotg,3006,4) ):
            if not( aop(iotg,3011,4) == aop(iotg,3006,4)-aop(iotg,3001,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3011 kol. 4 = AOP-u (3006 - 3001) kol. 4 , ako je AOP 3001 kol. 4 < AOP-a 3006 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3001,3) == aop(iotg,3006,3) ):
            if not( suma(iotg,3010,3011,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3010 + 3011) kol. 3 = 0, ako je AOP 3001 kol. 3 = AOP-u 3006 kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3001,4) == aop(iotg,3006,4) ):
            if not( suma(iotg,3010,3011,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3010 + 3011) kol. 4 = 0, ako je AOP 3001 kol. 4 = AOP-u 3006 kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3010,3) > 0 ):
            if not( aop(iotg,3011,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3010 kol. 3 > 0 onda je AOP 3011 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3011,3) > 0 ):
            if not( aop(iotg,3010,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3011 kol. 3 > 0 onda je AOP 3010 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3010,4) > 0 ):
            if not( aop(iotg,3011,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3010 kol. 4 > 0 onda je AOP 3011 kol. 4 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3011,4) > 0 ):
            if not( aop(iotg,3010,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3011 kol. 4 > 0 onda je AOP 3010 kol. 4 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3001,3011],3) == suma_liste(iotg,[3006,3010],3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3001 + 3011) kol. 3 = AOP-u (3006 + 3010) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3001,3011],4) == suma_liste(iotg,[3006,3010],4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3001 + 3011) kol. 4 = AOP-u (3006 + 3010) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3012,3) == suma(iotg,3013,3018,3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3012 kol. 3 = AOP-u (3013 + 3014 + 3015 + 3016 + 3017 + 3018) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3012,4) == suma(iotg,3013,3018,4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3012 kol. 4 = AOP-u (3013 + 3014 + 3015 + 3016 + 3017 + 3018) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3019,3) == suma(iotg,3020,3025,3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3019 kol. 3 = AOP-u (3020 + 3021 + 3022 + 3023 + 3024 + 3025) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3019,4) == suma(iotg,3020,3025,4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3019 kol. 4 = AOP-u (3020 + 3021 + 3022 + 3023 + 3024 + 3025) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3010,3012],3) > suma_liste(iotg,[3011,3019],3) ):
            if not( aop(iotg,3026,3) == suma_liste(iotg,[3010,3012],3)-suma_liste(iotg,[3011,3019],3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3026 kol. 3 = AOP-u (3010 - 3011 + 3012 - 3019) kol. 3, ako je AOP (3010 + 3012) kol. 3 > AOP-a (3011 + 3019) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3010,3012],4) > suma_liste(iotg,[3011,3019],4) ):
            if not( aop(iotg,3026,4) == suma_liste(iotg,[3010,3012],4)-suma_liste(iotg,[3011,3019],4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3026 kol. 4 = AOP-u (3010 - 3011 + 3012 - 3019) kol. 4, ako je AOP (3010 + 3012) kol. 4 > AOP-a (3011 + 3019) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3010,3012],3) < suma_liste(iotg,[3011,3019],3) ):
            if not( aop(iotg,3027,3) == suma_liste(iotg,[3011,3019],3)-suma_liste(iotg,[3010,3012],3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3027 kol. 3 = AOP-u (3011 - 3010 - 3012 + 3019) kol. 3, ako je AOP (3010 + 3012) kol. 3 < AOP-a (3011 + 3019) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3010,3012],4) < suma_liste(iotg,[3011,3019],4) ):
            if not( aop(iotg,3027,4) == suma_liste(iotg,[3011,3019],4)-suma_liste(iotg,[3010,3012],4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3027 kol. 4 = AOP-u (3011 - 3010 - 3012 + 3019) kol. 4, ako je AOP (3010 + 3012) kol. 4 < AOP-a (3011 + 3019) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3010,3012],3) == suma_liste(iotg,[3011,3019],3) ):
            if not( suma(iotg,3026,3027,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3026 + 3027) kol. 3 = 0, ako je AOP (3010 + 3012) kol. 3 = AOP-u (3011 + 3019) kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3010,3012],4) == suma_liste(iotg,[3011,3019],4) ):
            if not( suma(iotg,3026,3027,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3026 + 3027) kol. 4 = 0, ako je AOP (3010 + 3012) kol. 4 = AOP-u (3011 + 3019) kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3010,3012,3027],3) == suma_liste(iotg,[3011,3019,3026],3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3010 + 3012 + 3027) kol. 3 = AOP-u (3011 + 3019 + 3026) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3010,3012,3027],4) == suma_liste(iotg,[3011,3019,3026],4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3010 + 3012 + 3027) kol. 4 = AOP-u (3011 + 3019 + 3026) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3026,3) > suma(iotg,3027,3029,3) ):
            if not( aop(iotg,3030,3) == aop(iotg,3026,3)-suma(iotg,3027,3029,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3030 kol. 3 = AOP-u (3026 - 3027 - 3028 - 3029) kol. 3, ako je AOP 3026 kol. 3 > AOP-a (3027 + 3028 + 3029) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3026,4) > suma(iotg,3027,3029,4) ):
            if not( aop(iotg,3030,4) == aop(iotg,3026,4)-suma(iotg,3027,3029,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3030 kol. 4 = AOP-u (3026 - 3027 - 3028 - 3029) kol. 4, ako je AOP 3026 kol. 4 > AOP-a (3027 + 3028 + 3029) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3026,3) < suma(iotg,3027,3029,3) ):
            if not( aop(iotg,3031,3) == suma(iotg,3027,3029,3)-aop(iotg,3026,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3031 kol. 3 = AOP-u (3027 - 3026 + 3028 + 3029) kol. 3,  ako je AOP 3026 kol. 3 < AOP-a (3027 + 3028 + 3029) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3026,4) < suma(iotg,3027,3029,4) ):
            if not( aop(iotg,3031,4) == suma(iotg,3027,3029,4)-aop(iotg,3026,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3031 kol. 4 = AOP-u (3027 - 3026 + 3028 + 3029) kol. 4,  ako je AOP 3026 kol. 4 < AOP-a (3027 + 3028 + 3029) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3026,3) == suma(iotg,3027,3029,3) ):
            if not( suma(iotg,3030,3031,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3030 + 3031) kol. 3 = 0, ako je AOP 3026 kol. 3 = AOP-u (3027 + 3028 + 3029) kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3026,4) == suma(iotg,3027,3029,4) ):
            if not( suma(iotg,3030,3031,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3030 + 3031) kol. 4 = 0, ako je AOP 3026 kol. 4 = AOP-u (3027 + 3028 + 3029) kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3030,3) > 0 ):
            if not( aop(iotg,3031,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3030 kol. 3 > 0 onda je AOP 3031 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3031,3) > 0 ):
            if not( aop(iotg,3030,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3031 kol. 3 > 0 onda je AOP 3030 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3030,4) > 0 ):
            if not( aop(iotg,3031,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3030 kol. 4 > 0 onda je AOP 3031 kol. 4 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3031,4) > 0 ):
            if not( aop(iotg,3030,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3031 kol. 4 > 0 onda je AOP 3030 kol. 4 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3026,3031],3) == suma(iotg,3027,3030,3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3026 + 3031) kol. 3 = AOP-u (3027 + 3028 + 3029 + 3030) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3026,3031],4) == suma(iotg,3027,3030,4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3026 + 3031) kol. 4 = AOP-u (3027 + 3028 + 3029 + 3030) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3038,3) == suma(iotg,3039,3043,3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3038 kol. 3 = AOP-u (3039 + 3040 + 3041 + 3042 + 3043) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3038,4) == suma(iotg,3039,3043,4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3038 kol. 4 = AOP-u (3039 + 3040 + 3041 + 3042 + 3043) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3032,3) > aop(iotg,3038,3) ):
            if not( aop(iotg,3044,3) == aop(iotg,3032,3)-aop(iotg,3038,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3044 kol. 3 = AOP-u (3032 - 3038) kol. 3, ako je AOP 3032 kol. 3 > AOP-a 3038 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3032,4) > aop(iotg,3038,4) ):
            if not( aop(iotg,3044,4) == aop(iotg,3032,4)-aop(iotg,3038,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3044 kol. 4 = AOP-u (3032 - 3038) kol. 4, ako je AOP 3032 kol. 4 > AOP-a 3038 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3032,3) < aop(iotg,3038,3) ):
            if not( aop(iotg,3045,3) == aop(iotg,3038,3)-aop(iotg,3032,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3045 kol. 3 = AOP-u (3038 - 3032) kol. 3, ako je AOP 3032 kol. 3 < AOP-a 3038 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3032,4) < aop(iotg,3038,4) ):
            if not( aop(iotg,3045,4) == aop(iotg,3038,4)-aop(iotg,3032,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3045 kol. 4 = AOP-u (3038 - 3032) kol. 4, ako je AOP 3032 kol. 4 < AOP-a 3038 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3032,3) == aop(iotg,3038,3) ):
            if not( suma(iotg,3044,3045,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3044 + 3045) kol. 3 = 0,  ako je AOP 3032 kol. 3 = AOP-u 3038 kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3032,4) == aop(iotg,3038,4) ):
            if not( suma(iotg,3044,3045,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3044 + 3045) kol. 4 = 0,  ako je AOP 3032 kol. 4 = AOP-u 3038 kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3032,3045],3) == suma_liste(iotg,[3038,3044],3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP ( 3032 + 3045) kol. 3 = AOP-u (3038 + 3044) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3032,3045],4) == suma_liste(iotg,[3038,3044],4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP ( 3032 + 3045) kol. 4 = AOP-u (3038 + 3044) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3046,3) == suma(iotg,3047,3049,3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3046 kol. 3 = AOP-u (3047 + 3048 + 3049) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3046,4) == suma(iotg,3047,3049,4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3046 kol. 4 = AOP-u (3047 + 3048 + 3049) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3050,3) == suma(iotg,3051,3053,3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3050 kol. 3 = AOP-u (3051 + 3052 + 3053) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3050,4) == suma(iotg,3051,3053,4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3050 kol. 4 = AOP-u (3051 + 3052 + 3053) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3046,3) > aop(iotg,3050,3) ):
            if not( aop(iotg,3054,3) == aop(iotg,3046,3)-aop(iotg,3050,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3054 kol. 3 = AOP-u (3046 - 3050) kol. 3 , ako je AOP 3046 kol. 3 > AOP-a 3050 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3046,4) > aop(iotg,3050,4) ):
            if not( aop(iotg,3054,4) == aop(iotg,3046,4)-aop(iotg,3050,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3054 kol. 4 = AOP-u (3046 - 3050) kol. 4 , ako je AOP 3046 kol. 4 > AOP-a 3050 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3046,3) < aop(iotg,3050,3) ):
            if not( aop(iotg,3055,3) == aop(iotg,3050,3)-aop(iotg,3046,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3055 kol. 3 = AOP-u (3050 - 3046) kol. 3, ako je AOP 3046 kol. 3 < AOP-a 3050 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3046,4) < aop(iotg,3050,4) ):
            if not( aop(iotg,3055,4) == aop(iotg,3050,4)-aop(iotg,3046,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3055 kol. 4 = AOP-u (3050 - 3046) kol. 4, ako je AOP 3046 kol. 4 < AOP-a 3050 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3046,3) == aop(iotg,3050,3) ):
            if not( suma(iotg,3054,3055,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3054 + 3055) kol. 3 = 0, ako je AOP 3046 kol. 3 = AOP-u 3050 kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3046,4) == aop(iotg,3050,4) ):
            if not( suma(iotg,3054,3055,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3054 + 3055) kol. 4 = 0, ako je AOP 3046 kol. 4 = AOP-u 3050 kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3054,3) > 0 ):
            if not( aop(iotg,3055,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3054 kol. 3 > 0 onda je AOP 3055 kol. 3 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3055,3) > 0 ):
            if not( aop(iotg,3054,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3055 kol. 3 > 0 onda je AOP 3054 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3054,4) > 0 ):
            if not( aop(iotg,3055,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3054 kol. 4 > 0 onda je AOP 3055 kol. 4 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3055,4) > 0 ):
            if not( aop(iotg,3054,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3055 kol. 4 > 0 onda je AOP 3054 kol. 4 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto prilivi i odlivi '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3046,3055],3) == suma_liste(iotg,[3050,3054],3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3046 + 3055) kol. 3 = AOP-u (3050 + 3054) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3046,3055],4) == suma_liste(iotg,[3050,3054],4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3046 + 3055) kol. 4 = AOP-u (3050 + 3054) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3056,3) == suma_liste(iotg,[3001,3012,3032,3046],3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3056 kol. 3 = AOP-u (3001 + 3012 + 3032 + 3046) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3056,4) == suma_liste(iotg,[3001,3012,3032,3046],4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3056 kol. 4 = AOP-u (3001 + 3012 + 3032 + 3046) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3057,3) == suma_liste(iotg,[3006,3019,3028,3029,3038,3050],3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3057 kol. 3 = AOP-u (3006 + 3019 + 3028 + 3029 + 3038 + 3050) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3057,4) == suma_liste(iotg,[3006,3019,3028,3029,3038,3050],4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3057 kol. 4 = AOP-u (3006 + 3019 + 3028 + 3029 + 3038 + 3050) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3056,3) > aop(iotg,3057,3) ):
            if not( aop(iotg,3058,3) == aop(iotg,3056,3)-aop(iotg,3057,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3058 kol. 3 = AOP-u (3056 - 3057) kol. 3, ako je AOP 3056 kol. 3 > AOP-a 3057 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3056,4) > aop(iotg,3057,4) ):
            if not( aop(iotg,3058,4) == aop(iotg,3056,4)-aop(iotg,3057,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3058 kol. 4 = AOP-u (3056 - 3057) kol. 4, ako je AOP 3056 kol. 4 > AOP-a 3057 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3056,3) < aop(iotg,3057,3) ):
            if not( aop(iotg,3059,3) == aop(iotg,3057,3)-aop(iotg,3056,3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3059 kol. 3 = AOP-u (3057 - 3056) kol. 3, ako je AOP 3056 kol. 3 < AOP-a 3057 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3056,4) < aop(iotg,3057,4) ):
            if not( aop(iotg,3059,4) == aop(iotg,3057,4)-aop(iotg,3056,4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3059 kol. 4 = AOP-u (3057 - 3056) kol. 4, ako je AOP 3056 kol. 4 < AOP-a 3057 kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3056,3) == aop(iotg,3057,3) ):
            if not( suma(iotg,3058,3059,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3058 + 3059) kol. 3 = 0, ako je AOP 3056 kol. 3 = AOP-u 3057 kol. 3 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3056,4) == aop(iotg,3057,4) ):
            if not( suma(iotg,3058,3059,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP (3058 + 3059) kol. 4 = 0, ako je AOP 3056 kol. 4 = AOP-u 3057 kol. 4 Rezultat mora biti jednak 0 ukoliko su prilivi i odlivi međusobno jednaki '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3058,3) > 0 ):
            if not( aop(iotg,3059,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3058 kol. 3 > 0 onda je AOP 3059 kol. 3 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto povećanja i smanjenja gotovine '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3059,3) > 0 ):
            if not( aop(iotg,3058,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3059 kol. 3 > 0 onda je AOP 3058 kol. 3 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto povećanja i smanjenja gotovine '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3058,4) > 0 ):
            if not( aop(iotg,3059,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3058 kol. 4 > 0 onda je AOP 3059 kol. 4 = 0  U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto povećanja i smanjenja gotovine '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iotg,3059,4) > 0 ):
            if not( aop(iotg,3058,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='Ako je AOP 3059 kol. 4 > 0 onda je AOP 3058 kol. 4 = 0 U Izveštaju o tokovima gotovine ne mogu biti istovremeno prikazani neto povećanja i smanjenja gotovine '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3056,3059],3) == suma(iotg,3057,3058,3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3056 + 3059) kol. 3 = AOP-u (3057 + 3058) kol. 3 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(iotg,[3056,3059],4) == suma(iotg,3057,3058,4) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP (3056 + 3059) kol. 4 = AOP-u (3057 + 3058) kol. 4 Kontrolno pravilo odražava princip bilansne ravnoteže; Proverite prethodno nezadovoljena kontrolna pravila i izvršite neophodne ispravke '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3058,3060,3061],3) > suma_liste(iotg,[3059,3062],3) ):
            if not( aop(iotg,3063,3) == suma_liste(iotg,[3058,3060,3061],3)-suma_liste(iotg,[3059,3062],3) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3063 kol. 3 = AOP-u (3058 - 3059 + 3060 + 3061 - 3062) kol. 3, ako je AOP (3058 + 3060 + 3061) kol. 3 > AOP-a (3059 + 3062) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3058,3060,3061],4) > suma_liste(iotg,[3059,3062],4) ):
            if not( aop(iotg,3063,4) == suma_liste(iotg,[3058,3060,3061],4)-suma_liste(iotg,[3059,3062],4) ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3063 kol. 4 = AOP-u (3058 - 3059 + 3060 + 3061 - 3062) kol. 4, ako je AOP (3058 + 3060 + 3061) kol. 4 > AOP-a (3059 + 3062) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3058,3060,3061],3) <= suma_liste(iotg,[3059,3062],3) ):
            if not( aop(iotg,3063,3) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3063 kol. 3 = 0, ako je AOP (3058 + 3060 + 3061) kol. 3 ≤ AOP-a (3059 + 3062) kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iotg,[3058,3060,3061],4) <= suma_liste(iotg,[3059,3062],4) ):
            if not( aop(iotg,3063,4) == 0 ):
                ...
                naziv_obrasca='Izveštaj o tokovima gotovine'
                poruka  ='AOP 3063 kol. 4 = 0, ako je AOP (3058 + 3060 + 3061) kol. 4 ≤ AOP-a (3059 + 3062) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( aop(iotg,3063,4) == aop(iotg,3060,3) ):
            ...
            naziv_obrasca='Izveštaj o tokovima gotovine'
            poruka  ='AOP 3063 kol. 4 = AOP-u 3060 kol. 3  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(iopk,4001, 4138, 1)  > 0 ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='Zbir podataka na oznakama za AOP (4001 do 4138) > 0 Izveštaj o promenama na kapitalu mora imati iskazane podatke; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4026,1) == suma(iopk,4023,4024,1)-aop(iopk,4025,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4026 = AOP-u (4023 + 4024 - 4025)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4048,1) == suma(iopk,4045,4046,1)-aop(iopk,4047,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4048 = AOP-u (4045 + 4046 - 4047)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4062,1) == suma(iopk,4059,4060,1)-aop(iopk,4061,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4062= AOP-u (4059 + 4060 - 4061)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4076,1) == suma(iopk,4073,4074,1)-aop(iopk,4075,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4076 = AOP-u (4073 + 4074 - 4075)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4104,1) == suma(iopk,4101,4102,1)-aop(iopk,4103,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4104 = AOP-u (4101 + 4102 - 4103)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4001,4023,4045,4073],1) > aop(iopk,4059,1) + aop(iopk,4101,1) ):
            if not( aop(iopk,4127,1) == suma_liste(iopk,[4001,4023,4045,4073],1)-suma_liste(iopk,[4059,4101],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4127 = AOP-u (4001 + 4023 + 4045 - 4059 + 4073 - 4101), ako je AOP (4001 + 4023 + 4045 + 4073) > AOP-a (4059 + 4101)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4001,4023,4045,4073],1) < aop(iopk,4059,1) + aop(iopk,4101,1) ):
            if not( aop(iopk,4133,1) == suma_liste(iopk,[4059,4101],1)-suma_liste(iopk,[4001,4023,4045,4073],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4133 = AOP-u (4059 - 4001 - 4023 - 4045 - 4073 + 4101), ako je AOP (4001 + 4023 + 4045 + 4073) < AOP-a (4059 + 4101)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4001,4023,4045,4073],1) == aop(iopk,4059,1) + aop(iopk,4101,1) ):
            if not( aop(iopk,4127,1) + aop(iopk,4133,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4127 + 4133) = 0, ako je AOP (4001 + 4023 + 4045 + 4073) = AOP-u (4059 + 4101) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4127,1) > 0 ):
            if not( aop(iopk,4133,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4127 > 0, onda je AOP 4133 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4133,1) > 0 ):
            if not( aop(iopk,4127,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4133 > 0, onda je AOP 4127 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4004,4026,4048,4076],1) > aop(iopk,4062,1) + aop(iopk,4104,1) ):
            if not( aop(iopk,4128,1) == suma_liste(iopk,[4004,4026,4048,4076],1)-suma_liste(iopk,[4062,4104],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4128 = AOP-u (4004 + 4026 + 4048 - 4062 + 4076 - 4104), ako je AOP (4004 + 4026 + 4048 + 4076) > AOP-a (4062 + 4104)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4004,4026,4048,4076],1) < aop(iopk,4062,1) + aop(iopk,4104,1) ):
            if not( aop(iopk,4134,1) == suma_liste(iopk,[4062,4104],1)-suma_liste(iopk,[4004,4026,4048,4076],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4134 = AOP-u (4062 - 4004 - 4026 - 4048 - 4076 + 4104), ako je AOP (4004 + 4026 + 4048 + 4076) < AOP-a (4062 + 4104)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4004,4026,4048,4076],1) == aop(iopk,4062,1) + aop(iopk,4104,1) ):
            if not( aop(iopk,4128,1) + aop(iopk,4134,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4128 + 4134) = 0, ako je AOP (4004 + 4026 + 4048 + 4076) = AOP-u (4062 + 4104) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4128,1) > 0 ):
            if not( aop(iopk,4134,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4128 > 0, onda je AOP 4134 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4134,1) > 0 ):
            if not( aop(iopk,4128,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4134 > 0, onda je AOP 4128 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4077,1) > 0 ):
            if not( aop(iopk,4105,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4077 > 0, onda je AOP 4105 = 0 Ne mogu biti istovremeno prikazani dobitak i gubitak poslovne godine '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4105,1) > 0 ):
            if not( aop(iopk,4077,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4105 > 0, onda je AOP 4077 = 0 Ne mogu biti istovremeno prikazani dobitak i gubitak poslovne godine '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4005,1) + aop(iopk,4007,1) > aop(iopk,4006,1) + aop(iopk,4008,1) ):
            if not( aop(iopk,4009,1) == suma_liste(iopk,[4005,4007],1)-suma_liste(iopk,[4006,4008],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4009 = AOP-u (4005 - 4006 + 4007 - 4008), ako je AOP (4005 + 4007) > AOP-a (4006 + 4008)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4005,1) + aop(iopk,4007,1) < aop(iopk,4006,1) + aop(iopk,4008,1) ):
            if not( aop(iopk,4010,1) == suma_liste(iopk,[4006,4008],1)-suma_liste(iopk,[4005,4007],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4010 = AOP-u (4006 - 4005 - 4007 + 4008), ako je AOP (4005 + 4007) < AOP-a (4006 + 4008)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4005,1) + aop(iopk,4007,1) == aop(iopk,4006,1) + aop(iopk,4008,1) ):
            if not( aop(iopk,4009,1) + aop(iopk,4010,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4009 + 4010) = 0, ako je AOP (4005 + 4007) = AOP-u (4006 + 4008) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4009,1) > 0 ):
            if not( aop(iopk,4010,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4009 > 0, onda je AOP 4010 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4010,1) > 0 ):
            if not( aop(iopk,4009,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4010 > 0, onda je AOP 4009 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4027,1) + aop(iopk,4029,1) > aop(iopk,4028,1) + aop(iopk,4030,1) ):
            if not( aop(iopk,4031,1) == suma_liste(iopk,[4027,4029],1)-suma_liste(iopk,[4028,4030],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4031 = AOP-u (4027 - 4028 + 4029 - 4030), ako je AOP (4027 + 4029) > AOP-a (4028 + 4030)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4027,1) + aop(iopk,4029,1) < aop(iopk,4028,1) + aop(iopk,4030,1) ):
            if not( aop(iopk,4032,1) == suma_liste(iopk,[4028,4030],1)-suma_liste(iopk,[4027,4029],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4032 = AOP-u (4028 - 4027 - 4029 + 4030), ako je AOP (4027 + 4029) < AOP-a (4028 + 4030)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4027,1) + aop(iopk,4029,1) == aop(iopk,4028,1) + aop(iopk,4030,1) ):
            if not( aop(iopk,4031,1) + aop(iopk,4032,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4031 + 4032) = 0, ako je AOP (4027 + 4029) = AOP-u (4028 + 4030) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4031,1) > 0 ):
            if not( aop(iopk,4032,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4031 > 0, onda je AOP 4032 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4032,1) > 0 ):
            if not( aop(iopk,4031,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4032 > 0, onda je AOP 4031 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4082,1) > suma_liste(iopk,[4080,4081,4083],1) ):
            if not( aop(iopk,4084,1) == aop(iopk,4082,1)-suma_liste(iopk,[4080,4081,4083],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4084 = AOP-u (4082 - 4080 - 4081 - 4083), ako je AOP 4082 > AOP-a (4080 + 4081 + 4083)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4082,1) < suma_liste(iopk,[4080,4081,4083],1) ):
            if not( aop(iopk,4085,1) == suma_liste(iopk,[4080,4081,4083],1)-aop(iopk,4082,1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4085 = AOP-u (4080 - 4082 + 4081 + 4083), ako je AOP 4082 < AOP-a (4080 + 4081 + 4083)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4082,1) == suma_liste(iopk,[4080,4081,4083],1) ):
            if not( aop(iopk,4084,1) + aop(iopk,4085,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4084 + 4085) = 0, ako je AOP 4082 = AOP-u (4080 + 4081 + 4083) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4084,1) > 0 ):
            if not( aop(iopk,4085,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4084 > 0, onda je AOP 4085 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4085,1) > 0 ):
            if not( aop(iopk,4084,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4085 > 0, onda je AOP 4084 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4109,1) > aop(iopk,4108,1) + aop(iopk,4110,1) ):
            if not( aop(iopk,4111,1) == aop(iopk,4109,1)-suma_liste(iopk,[4108,4110],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4111 = AOP-u (4109 - 4108 - 4110), ako je AOP 4109 > AOP-a (4108 + 4110)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4109,1) < aop(iopk,4108,1) + aop(iopk,4110,1) ):
            if not( aop(iopk,4112,1) == suma_liste(iopk,[4108,4110],1)-aop(iopk,4109,1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4112 = AOP-u (4108 - 4109 + 4110), ako je AOP 4109 < AOP-a (4108 + 4110)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4109,1) == aop(iopk,4108,1) + aop(iopk,4110,1) ):
            if not( aop(iopk,4111,1) + aop(iopk,4112,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4111 + 4112) = 0, ako je AOP 4109 = AOP-u (4108 + 4110) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4111,1) > 0 ):
            if not( aop(iopk,4112,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4111 > 0, onda je AOP 4112 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4112,1) > 0 ):
            if not( aop(iopk,4111,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4112 > 0, onda je AOP 4111= 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4011,1) == suma_liste(iopk,[4004,4009],1)-aop(iopk,4010,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4011 = AOP-u (4004 + 4009 - 4010)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4033,1) == suma_liste(iopk,[4026,4031],1)-aop(iopk,4032,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4033 = AOP-u (4026 + 4031 - 4032)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4051,1) == suma(iopk,4048,4049,1)-aop(iopk,4050,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4051 = AOP-u (4048 + 4049 - 4050)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4065,1) == suma_liste(iopk,[4062,4064],1)-aop(iopk,4063,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4065 = AOP-u (4062 - 4063 + 4064)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4086,1) == suma_liste(iopk,[4076,4077,4078,4084],1)-suma_liste(iopk,[4079,4085],1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4086 = AOP-u (4076 + 4077 + 4078 - 4079 + 4084 - 4085)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4113,1) == suma_liste(iopk,[4104,4105,4106,4111],1)-suma_liste(iopk,[4107,4112],1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4113 = AOP-u (4104 + 4105 + 4106 - 4107 + 4111 - 4112)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4011,4033,4051,4086],1) > aop(iopk,4065,1) + aop(iopk,4113,1) ):
            if not( aop(iopk,4129,1) == suma_liste(iopk,[4011,4033,4051,4086],1)-suma_liste(iopk,[4065,4113],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4129 = AOP-u (4011 + 4033 + 4051 - 4065 + 4086 - 4113), ako je AOP (4011 + 4033 + 4051 + 4086) > AOP-a (4065 + 4113)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4011,4033,4051,4086],1) < aop(iopk,4065,1) + aop(iopk,4113,1) ):
            if not( aop(iopk,4135,1) == suma_liste(iopk,[4065,4113],1)-suma_liste(iopk,[4011,4033,4051,4086],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4135 = AOP-u (4065 - 4011 - 4033 - 4051 - 4086 + 4113), ako je AOP (4011 + 4033 + 4051 + 4086) < AOP-a (4065 + 4113)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4011,4033,4051,4086],1) == aop(iopk,4065,1) + aop(iopk,4113,1) ):
            if not( aop(iopk,4129,1) + aop(iopk,4135,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4129 + 4135) = 0, ako je AOP (4011 + 4033 + 4051 + 4086) = AOP-u (4065 + 4113) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4129,1) > 0 ):
            if not( aop(iopk,4135,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4129 > 0, onda je AOP 4135 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4135,1) > 0 ):
            if not( aop(iopk,4129,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4135 > 0, onda je AOP 4129 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4012,1) == aop(iopk,4011,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4012 = AOP-u 4011  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4034,1) == aop(iopk,4033,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4034 = AOP-u 4033  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4052,1) == aop(iopk,4051,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4052 = AOP-u 4051  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4114,1) == aop(iopk,4113,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4114 = AOP-u 4113  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4130,1) == aop(iopk,4129,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4130 = AOP-u 4129  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4015,1) == suma(iopk,4012,4013,1)-aop(iopk,4014,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4015 = AOP-u (4012 + 4013 - 4014)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4037,1) == suma(iopk,4034,4035,1)-aop(iopk,4036,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4037 = AOP-u (4034 + 4035 - 4036)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4055,1) == suma(iopk,4052,4053,1)-aop(iopk,4054,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4055 = AOP-u (4052 + 4053 - 4054)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4069,1) == suma(iopk,4066,4067,1)-aop(iopk,4068,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4069= AOP-u (4066 + 4067 - 4068)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4117,1) == suma(iopk,4114,4115,1)-aop(iopk,4116,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4117 = AOP-u (4114 + 4115 - 4116)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4015,4037,4055,4090],1) > aop(iopk,4069,1) + aop(iopk,4117,1) ):
            if not( aop(iopk,4131,1) == suma_liste(iopk,[4015,4037,4055,4090],1)-suma_liste(iopk,[4069,4117],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4131 = AOP-u (4015 + 4037 + 4055 - 4069 + 4090 - 4117), ako je AOP (4015 + 4037 + 4055 + 4090) > AOP-a (4069 + 4117)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4015,4037,4055,4090],1) < aop(iopk,4069,1) + aop(iopk,4117,1) ):
            if not( aop(iopk,4137,1) == suma_liste(iopk,[4069,4117],1)-suma_liste(iopk,[4015,4037,4055,4090],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4137= AOP-u (4069 - 4015 - 4037 - 4055 - 4090 + 4117), ako je AOP (4015 + 4037 + 4055 + 4090) < AOP-a (4069 + 4117)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4015,4037,4055,4090],1) == aop(iopk,4069,1) + aop(iopk,4117,1) ):
            if not( aop(iopk,4131,1) + aop(iopk,4137,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4131 + 4137) = 0, ako je AOP (4015 + 4037 + 4055 + 4090) = AOP-u (4069 + 4117) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4131,1) > 0 ):
            if not( aop(iopk,4137,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4131 > 0, onda je AOP 4137 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4137,1) > 0 ):
            if not( aop(iopk,4131,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4137 > 0, onda je AOP 4131 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4091,1) > 0 ):
            if not( aop(iopk,4118,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4091 > 0, onda je AOP 4118 = 0 Ne mogu biti istovremeno prikazani dobitak i gubitak poslovne godine '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4118,1) > 0 ):
            if not( aop(iopk,4091,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je  AOP 4118 > 0, onda je AOP 4091 = 0 Ne mogu biti istovremeno prikazani dobitak i gubitak poslovne godine '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4016,1) + aop(iopk,4018,1) > aop(iopk,4017,1) + aop(iopk,4019,1) ):
            if not( aop(iopk,4020,1) == suma_liste(iopk,[4016,4018],1)-suma_liste(iopk,[4017,4019],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4020 = AOP-u (4016 - 4017 + 4018 - 4019), ako je AOP (4016 + 4018) > AOP-a (4017 + 4019)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4016,1) + aop(iopk,4018,1) < aop(iopk,4017,1) + aop(iopk,4019,1) ):
            if not( aop(iopk,4021,1) == suma_liste(iopk,[4017,4019],1)-suma_liste(iopk,[4016,4018],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4021 = AOP-u (4017 - 4016 - 4018 + 4019), ako je AOP (4016 + 4018) < AOP-a (4017 + 4019)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4016,1) + aop(iopk,4018,1) == aop(iopk,4017,1) + aop(iopk,4019,1) ):
            if not( aop(iopk,4020,1) + aop(iopk,4021,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4020 + 4021) = 0, ako je AOP (4016 + 4018) = AOP-u (4017 + 4019) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4020,1) > 0 ):
            if not( aop(iopk,4021,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4020 > 0, onda je AOP 4021 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4021,1) > 0 ):
            if not( aop(iopk,4020,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4021 > 0, onda je AOP 4020 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4038,1) + aop(iopk,4040,1) > aop(iopk,4039,1) + aop(iopk,4041,1) ):
            if not( aop(iopk,4042,1) == suma_liste(iopk,[4038,4040],1)-suma_liste(iopk,[4039,4041],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4042 = AOP-u (4038 - 4039 + 4040 - 4041), ako je AOP (4038 + 4040) > AOP-a (4039 + 4041)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4038,1) + aop(iopk,4040,1) < aop(iopk,4039,1) + aop(iopk,4041,1) ):
            if not( aop(iopk,4043,1) == suma_liste(iopk,[4039,4041],1)-suma_liste(iopk,[4038,4040],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4043 = AOP-u (4039 - 4038 - 4040 + 4041), ako je AOP (4038 + 4040) < AOP-a (4039 + 4041)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4038,1) + aop(iopk,4040,1) == aop(iopk,4039,1) + aop(iopk,4041,1) ):
            if not( aop(iopk,4042,1) + aop(iopk,4043,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4042 + 4043) = 0, ako je AOP (4038 + 4040) = AOP-u (4039 + 4041) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4042,1) > 0 ):
            if not( aop(iopk,4043,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4042 > 0, onda je AOP 4043 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4043,1) > 0 ):
            if not( aop(iopk,4042,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4043 > 0, onda je AOP 4042 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4096,1) > suma_liste(iopk,[4094,4095,4097],1) ):
            if not( aop(iopk,4098,1) == aop(iopk,4096,1)-suma_liste(iopk,[4094,4095,4097],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4098 = AOP-u (4096 - 4094 - 4095 - 4097), ako je AOP 4096 > AOP-a (4094 + 4095 + 4097)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4096,1) < suma_liste(iopk,[4094,4095,4097],1) ):
            if not( aop(iopk,4099,1) == suma_liste(iopk,[4094,4095,4097],1)-aop(iopk,4096,1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4099 = AOP-u (4094 + 4095 - 4096 + 4097), ako je AOP 4096 < AOP-a (4094 + 4095 + 4097)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4096,1) == suma_liste(iopk,[4094,4095,4097],1) ):
            if not( aop(iopk,4098,1) + aop(iopk,4099,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4098 + 4099) = 0, ako je AOP 4096 = AOP-u (4094 + 4095 + 4097) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4098,1) > 0 ):
            if not( aop(iopk,4099,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4098 > 0, onda je AOP 4099 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4099,1) > 0 ):
            if not( aop(iopk,4098,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4099 > 0, onda je AOP 4098 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4122,1) > aop(iopk,4121,1) + aop(iopk,4123,1) ):
            if not( aop(iopk,4124,1) == aop(iopk,4122,1)-suma_liste(iopk,[4121,4123],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4124 = AOP-u (4122 - 4121 - 4123), ako je AOP 4122 > AOP-a (4121 + 4123)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4122,1) < aop(iopk,4121,1) + aop(iopk,4123,1) ):
            if not( aop(iopk,4125,1) == suma_liste(iopk,[4121,4123],1)-aop(iopk,4122,1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4125 = AOP-u (4121 - 4122 + 4123), ako je AOP 4122 < AOP-a (4121 + 4123)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4122,1) == aop(iopk,4121,1) + aop(iopk,4123,1) ):
            if not( aop(iopk,4124,1) + aop(iopk,4125,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4124 + 4125) = 0, ako je AOP 4122 = AOP-u (4121 + 4123) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4124,1) > 0 ):
            if not( aop(iopk,4125,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4124 > 0, onda je AOP 4125 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4125,1) > 0 ):
            if not( aop(iopk,4124,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4125 > 0, onda je AOP 4124 = 0 Ne mogu biti istovremeno prikazane pozitivne i negativne transakcije raspodele '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4022,1) == suma_liste(iopk,[4015,4020],1)-aop(iopk,4021,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4022 = AOP-u (4015 + 4020 - 4021)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4044,1) == suma_liste(iopk,[4037,4042],1)-aop(iopk,4043,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4044 = AOP-u (4037 + 4042 - 4043)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4058,1) == suma(iopk,4055,4056,1)-aop(iopk,4057,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4058 = AOP-u (4055 + 4056 - 4057)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4072,1) == suma_liste(iopk,[4069,4071],1)-aop(iopk,4070,1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4072 = AOP-u (4069 - 4070 + 4071)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4100,1) == suma_liste(iopk,[4090,4091,4092,4098],1)-suma_liste(iopk,[4093,4099],1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4100 = AOP-u (4090 + 4091 + 4092 - 4093 + 4098 - 4099)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(iopk,4126,1) == suma_liste(iopk,[4117,4118,4119,4124],1)-suma_liste(iopk,[4120,4125],1) ):
            ...
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='AOP 4126 = AOP-u (4117 + 4118 + 4119 - 4120 + 4124 - 4125)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4022,4044,4058,4100],1) > aop(iopk,4072,1) + aop(iopk,4126,1) ):
            if not( aop(iopk,4132,1) == suma_liste(iopk,[4022,4044,4058,4100],1)-suma_liste(iopk,[4072,4126],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4132 = AOP-u (4022 + 4044 + 4058 - 4072 + 4100 - 4126), ako je AOP (4022 + 4044 + 4058 + 4100) > AOP-a (4072 + 4126)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4022,4044,4058,4100],1) < aop(iopk,4072,1) + aop(iopk,4126,1) ):
            if not( aop(iopk,4138,1) == suma_liste(iopk,[4072,4126],1)-suma_liste(iopk,[4022,4044,4058,4100],1) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP 4138 = AOP-u (4072 - 4022 - 4044 - 4058 - 4100 + 4126), ako je AOP (4022 + 4044 + 4058 + 4100) < AOP-a (4072 + 4126)  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( suma_liste(iopk,[4022,4044,4058,4100],1) == aop(iopk,4072,1) + aop(iopk,4126,1) ):
            if not( aop(iopk,4132,1) + aop(iopk,4138,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4132 + 4138) = 0, ako je AOP (4022 + 4044 + 4058 + 4100) = AOP-u (4072 + 4126) Rezultat mora biti jednak 0 ukoliko su pozitivne i odbitne stavke međusobno jednake '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4132,1) > 0 ):
            if not( aop(iopk,4138,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4132 > 0, onda je AOP 4138 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4138,1) > 0 ):
            if not( aop(iopk,4132,1) == 0 ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='Ako je AOP 4138 > 0, onda je AOP 4132 = 0 Ne mogu biti istovremeno prikazani ukupan kapital i ukupan nedostatak kapitala '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(iopk,4026,1) + aop(iopk,4048,1) < aop(iopk,4062,1) ):
            if not( aop(iopk,4062,1)-suma_liste(iopk,[4026,4048],1) == aop(bs,417,7) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4062 - 4026 - 4048) = AOP-a 0417 kol. 7 bilansa stanja, ako je AOP (4026 + 4048) < AOP-a 4062 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo se primenjuje ukoliko Narodna banka Srbije vrši reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_warnings.append(poruka_obrasca)
                naziv_obrasca='Bilans stanja'
        ...
        if not( aop(iopk,4076,1) == aop(bs,418,7) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4076 = AOP-u 0418 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo se primenjuje ukoliko Narodna banka Srbije vrši reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4104,1) == aop(bs,419,7) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4104 = AOP-u 0419 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo se primenjuje ukoliko Narodna banka Srbije vrši reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4128,1) == aop(bs,420,7) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4128 = AOP-u 0420 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo se primenjuje ukoliko Narodna banka Srbije vrši reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4134,1) == aop(bs,421,7) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4134 = AOP-u 0421 kol. 7 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju; ovo pravilo se primenjuje ukoliko Narodna banka Srbije vrši reklasifikaciju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4011,1) == aop(bs,415,6) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4011 = AOP-u 0415 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if( aop(iopk,4033,1) + aop(iopk,4051,1) >= aop(iopk,4065,1) ):
            if not( suma_liste(iopk,[4033,4051],1)-aop(iopk,4065,1) == aop(bs,416,6) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4033 + 4051 - 4065) = AOP-u 0416 kol. 6 bilansa stanja, ako je AOP (4033 + 4051)  ≥  AOP-a 4065 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
                naziv_obrasca='Bilans stanja'
        ...
        if( aop(iopk,4033,1) + aop(iopk,4051,1) < aop(iopk,4065,1) ):
            if not( aop(iopk,4065,1)-suma_liste(iopk,[4033,4051],1) == aop(bs,417,6) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4065 - 4033 - 4051) = AOP-u 0417 kol. 6 bilansa stanja, ako je AOP (4033 + 4051) < AOP-a 4065 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
                naziv_obrasca='Bilans stanja'
        ...
        if not( aop(iopk,4086,1) == aop(bs,418,6) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4086 = AOP-u 0418 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4113,1) == aop(bs,419,6) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4113 = AOP-u 0419 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4129,1) == aop(bs,420,6) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4129 = AOP-u 0420 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4135,1) == aop(bs,421,6) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4135 = AOP-u 0421 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4022,1) == aop(bs,415,5) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4022 = AOP-u 0415 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if( aop(iopk,4044,1) + aop(iopk,4058,1) >= aop(iopk,4072,1) ):
            if not( suma_liste(iopk,[4044,4058],1)-aop(iopk,4072,1) == aop(bs,416,5) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4044 + 4058 - 4072) = AOP-u 0416 kol. 5 bilansa stanja, ako je AOP (4044 + 4058)  ≥  AOP-a 4072 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
                naziv_obrasca='Bilans stanja'
        ...
        if( aop(iopk,4044,1) + aop(iopk,4058,1) < aop(iopk,4072,1) ):
            if not( aop(iopk,4072,1)-suma_liste(iopk,[4044,4058],1) == aop(bs,417,5) ):
                ...
                naziv_obrasca='Izveštaj o promenama na kapitalu'
                poruka  ='AOP (4072 - 4044 - 4058) = AOP-u 0417 kol. 5 bilansa stanja, ako je AOP (4044 + 4058) < AOP-a 4072 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
                naziv_obrasca='Bilans stanja'
        ...
        if not( aop(iopk,4100,1) == aop(bs,418,5) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4100 = AOP-u 0418 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4126,1) == aop(bs,419,5) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4126 = AOP-u 0419 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4132,1) == aop(bs,420,5) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4132 = AOP-u 0420 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4138,1) == aop(bs,421,5) ):
            ...
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 4138 = AOP-u 0421 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4077,1) == aop(bu,1041,6) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP 4077 = AOP-u 1041 kol. 6 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4105,1) == aop(bu,1042,6) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP 4105 = AOP-u 1042 kol. 6 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4091,1) == aop(bu,1041,5) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP 4091 = AOP-u 1041 kol. 5 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( aop(iopk,4118,1) == aop(bu,1042,5) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP 4118 = AOP-u 1042 kol. 5 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju;  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Izveštaj o promenama na kapitalu'
        ...
        if not( suma(si,9001,9034,4) > 0 ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='Zbir podataka na oznakama za AOP (9001 do 9034) kol. 4 > 0 Statistički izveštaj mora imati iskazane podatke za tekući izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(si,9001,9034,5) > 0 ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='Zbir podataka na oznakama za AOP (9001 do 9034) kol. 5 > 0 Statistički izveštaj mora imati iskazane podatke za prethodni izveštajni period; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(si,9009,4) <= aop(si,9008,4) ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9009 kol. 4 ≤ AOP-a 9008 kol. 4  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(si,9009,5) <= aop(si,9008,5) ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9009 kol. 5 ≤ AOP-a 9008 kol. 5  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(si,9010,4) <= aop(si,9009,4) ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9010 kol. 4 ≤ AOP-a 9009 kol. 4  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(si,9010,5) <= aop(si,9009,5) ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9010 kol. 5 ≤ AOP-a 9009 kol. 5  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(si,9013,9017,4) <= aop(si,9012,4) ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP (9013 + 9014 + 9015 + 9016 + 9017) kol. 4 ≤ AOP-a 9012 kol. 4   '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma(si,9013,9017,5) <= aop(si,9012,5) ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP (9013 + 9014 + 9015 + 9016 + 9017) kol. 5 ≤ AOP-a 9012 kol. 5  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( suma_liste(si,[9007,9008,9012,9019,9020,9021],4) <= aop(bu,1031,5) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP (9007 + 9008 + 9012 + 9019 + 9020 + 9021) kol. 4 ≤  AOP-u 1031 kol. 5 bilansa uspeha Troškovi materijala, proizvodnih usluga, nematerijalni troškovi, troškovi doprinosa, novčane kazne i penali i ostali troškovi su izdvojeni deo ostalih rashoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        if not( suma_liste(si,[9007,9008,9012,9019,9020,9021],5) <= aop(bu,1031,6) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP (9007 + 9008 + 9012 + 9019 + 9020 + 9021) kol. 5 ≤  AOP-u 1031 kol. 6 bilansa uspeha Troškovi materijala, proizvodnih usluga, nematerijalni troškovi, troškovi doprinosa, novčane kazne i penali i ostali troškovi su izdvojeni deo ostalih rashoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        if not( aop(si,9011,4) == aop(bu,1029,5) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP 9011 kol. 4 = AOP-u 1029 kol. 5 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        if not( aop(si,9011,5) == aop(bu,1029,6) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP 9011 kol. 5 = AOP-u 1029 kol. 6 bilansa uspeha Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        if( aop(si,9027,4) > aop(si,9022,4) ):
            if not( aop(si,9027,4)-aop(si,9022,4) == aop(bu,1021,5) ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='AOP (9027 - 9022) kol. 4 = AOP-u 1021 kol. 5 bilansa uspeha, ako je AOP 9027 kol. 4 > AOP-a 9022 kol. 4 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
                naziv_obrasca='Bilans uspeha'
        ...
        if( aop(si,9027,5) > aop(si,9022,5) ):
            if not( aop(si,9027,5)-aop(si,9022,5) == aop(bu,1021,6) ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='AOP (9027 - 9022) kol. 5 = AOP-u 1021 kol. 6 bilansa uspeha, ako je AOP 9027 kol. 5 > AOP-a 9022 kol. 5 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
                naziv_obrasca='Bilans uspeha'
        ...
        if( aop(si,9027,4) < aop(si,9022,4) ):
            if not( aop(si,9022,4)-aop(si,9027,4) == aop(bu,1022,5) ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='AOP (9022 - 9027) kol. 4 = AOP-u 1022 kol. 5 bilansa uspeha, ako je AOP 9027 kol. 4 < AOP-a 9022 kol. 4 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
                naziv_obrasca='Bilans uspeha'
        ...
        if( aop(si,9027,5) < aop(si,9022,5) ):
            if not( aop(si,9022,5)-aop(si,9027,5) == aop(bu,1022,6) ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='AOP (9022 - 9027) kol. 5 = AOP-u 1022 kol. 6 bilansa uspeha, ako je AOP 9027 kol. 5 < AOP-a 9022 kol. 5 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
                naziv_obrasca='Bilans uspeha'
        ...
        if not( suma_liste(si,[9023,9025],4) <= aop(bu,1025,5) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP (9023 + 9025) kol. 4 ≤ AOP-a 1025 kol. 5 bilansa uspeha Ostali prihodi operativnog poslovanja i prihodi od dividendi i učešća su izdvojeni deo Ostalih poslovnih prihoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        if not( suma_liste(si,[9023,9025],5) <= aop(bu,1025,6) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP (9023 + 9025) kol. 5 ≤ AOP-a 1025 kol. 6 bilansa uspeha Ostali prihodi operativnog poslovanja i prihodi od dividendi i učešća su izdvojeni deo Ostalih poslovnih prihoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        if not( aop(si,9026,4) <= aop(bu,1030,5) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP 9026 kol. 4  ≤ AOP-a 1030 kol. 5 bilansa uspeha Prihodi od naknade štete po osnovu osiguranja su izdvojeni deo ostalih prihoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        if not( aop(si,9026,5) <= aop(bu,1030,6) ):
            ...
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP 9026 kol. 5  ≤ AOP-a 1030 kol. 6 bilansa uspeha Prihodi od naknade štete po osnovu osiguranja su izdvojeni deo ostalih prihoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        if not( aop(si,9034,3) > 0 ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9034 kol. 3 > 0 Na poziciji Prosečan broj zaposlenih nije iskazan podatak; Ukoliko podaci nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
        ...
        if not( aop(si,9034,4) <= 1000 ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9034 kol. 4 ≤ 1.000 Granične vrednosti date su da bi se izbegle slučajne greške prilikom iskazivanja broja zaposlenih; Zakonski zastupnik svojim potpisom potvrđuje ispravnost prikazanog broja zaposlenih; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
        ...
        if not( aop(si,9034,5) <= 1000 ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9034 kol. 5 ≤ 1.000 Granične vrednosti date su da bi se izbegle slučajne greške prilikom iskazivanja broja zaposlenih; Zakonski zastupnik svojim potpisom potvrđuje ispravnost prikazanog broja zaposlenih; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
