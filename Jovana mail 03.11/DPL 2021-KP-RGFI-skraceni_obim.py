...
def Validate(Zahtev):
    try:
       ...
       #Provera da li lice odgovorno za potpisivanje
        ...
        #00000-2
        if not( suma(bs,1,3,5)+suma(bs,1,3,6)+suma(bs,1,3,7)+suma(bs,9,14,5)+suma(bs,9,14,6)+suma(bs,9,14,7)+suma(bs,19,25,5)+suma(bs,19,25,6)+suma(bs,19,25,7)+suma(bs,401,405,5)+suma(bs,401,405,6)+suma(bs,401,405,7)+aop(bs,408,5)+aop(bs,408,6)+aop(bs,408,7)+suma(bs,411,413,5)+suma(bs,411,413,6)+suma(bs,411,413,7)+suma(bs,416,428,5)+suma(bs,416,428,6)+suma(bs,416,428,7)+suma(bu,1001,1048,5)+suma(bu,1001,1048,6)+suma_liste(si,[9007,9014,9015,9021,9022,9029,9030,9036],6)+suma(si,9037,9094,4)+suma(si,9037,9094,5)+suma(si,9095,9104,3)+suma(si,9095,9104,4) > 0 ):
            
            naziv_obrasca='Bilans stanja'
            poruka  ='Zbir podataka na oznakama za AOP (0001 do 0003) kol. 5 + (0001 do 0003) kol. 6 + (0001 do 0003) kol. 7 + (0009 do 0014) kol. 5 + (0009 do 0014) kol. 6 + (0009 do 0014) kol. 7 + (0019 do 0025) kol. 5 + (0019 do 0025) kol. 6 +  (0019 do 0025) kol. 7 bilansa stanja + (0401 do 0405) kol. 5 + (0401 do 0405) kol. 6 +  (0401 do 0405) kol. 7  + 0408 kol.5 + 0408 kol. 6 + 0408 kol. 7 + (0411 do 0413) kol. 5 + (0411 do 0413) kol. 6 +  (0411 do 0413) kol. 7 + (0416 do 0428) kol. 5 + (0416 do 0428) kol. 6 + (0416 do 0428) kol. 7  bilansa stanja + (1001 do 1048) kol. 5 + (1001 do 1048) kol. 6 bilansa uspeha +(9007 + 9014 + 9015 + 9021 + 9022 + 9029 + 9030 + 9036) kol. 6 + (9037 do 9094) kol. 4 + (9037 do 9094) kol. 5 + (9095 do 9104) kol. 3 + (9095 do 9104) kol. 4  statističkog izveštaja > 0 Finansijski izveštaj ne sme biti bez podataka; Ukoliko obveznik nije imao poslovnih događaja, niti u poslovnim knjigama ima podatke o imovini i obavezama dužno je da dostavi Izjavu o neaktivnosti;'
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Bilans uspeha'
