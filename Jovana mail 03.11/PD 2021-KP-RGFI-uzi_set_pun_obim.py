...
def Validate(Zahtev):
    try:
       ...
       #Provera da li lice odgovorno za potpisivanje
        ...
        #00000-8
        if not (Zahtev.ObveznikInfo.VelicinaObveznika.value__ == 1 and Zahtev.ObveznikInfo.GrupaObveznika.value__ == 8): 
            bsNapomene = Zahtev.Forme['Bilans stanja'].TekstualnaPoljaForme;
            buNapomene = Zahtev.Forme['Bilans uspeha'].TekstualnaPoljaForme;        

            if not (proveriNapomene(bsNapomene, 1, 60, 4) or proveriNapomene(bsNapomene, 401, 457, 4) or proveriNapomene(buNapomene, 1001, 1062, 4)  ):  
                
                naziv_obrasca='Bilans stanja'
                poruka  ='Na AOP-u (0001 do 0060) bilansa stanja + (0401 do 0457) bilansa stanja + (1001 do 1062) bilansa uspeha u koloni 4 (Napomena broj) mora biti unet bar jedan karakter; Potrebno je popuniti kolonu 4 u skladu sa oznakama iz Napomena uz finansijske izveštaje.'
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
                naziv_obrasca='Bilans uspeha'
        ...
        #00000-10
        if (Zahtev.ObveznikInfo.VelicinaObveznika.value__ == 1 and Zahtev.ObveznikInfo.GrupaObveznika.value__ == 8): 
            #U nijednoj od dve navedene forme kolona Napomena ne sme da bude popunjena
            bsNapomene = Zahtev.Forme['Bilans stanja'].TekstualnaPoljaForme;
            buNapomene = Zahtev.Forme['Bilans uspeha'].TekstualnaPoljaForme;
            if ( proveriNapomene(bsNapomene,1,60,4) or proveriNapomene(bsNapomene,401,457,4)  or proveriNapomene(buNapomene,1001,1062,4) ):
