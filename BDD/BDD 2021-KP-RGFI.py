...
def Validate(Zahtev):
    try:
       ...
       #Provera da li lice odgovorno za potpisivanje
        ...
        #00000-1
        if not( suma(bs,1,30,5)+suma(bs,1,30,6)+suma(bs,1,30,7)+suma(bs,401,448,5)+suma(bs,401,448,6)+suma(bs,401,448,7)+suma(bu,1001,1038,5)+suma(bu,1001,1038,6)+suma(ioor,2001,2026,5)+suma(ioor,2001,2026,6)+suma(iotg,3001,3049,3)+suma(iotg,3001,3049,4)+suma(iopk,4001,4264,1)+suma_liste(si,[9005,9010,9011,9016],6)+suma(si,9017,9055,4)+suma(si,9017,9055,5) > 0 ):
            
            naziv_obrasca='Bilans stanja'
            poruka  ='Zbir podataka na oznakama za AOP (0001 do 0030) kol.5 +  (0001 do 0030) kol.6 + (0001 do 0030) kol.7 bilansa stanja + (0401 do 0448) kol. 5 + (0401 do 0448) kol. 6 + (0401 do 0448) kol. 7 bilansa stanja + (1001 do 1038) kol. 5 + (1001 do 1038) kol. 6 bilansa uspeha + (2001 do 2026) kol. 5 + (2001 do 2026) kol. 6 izveštaja o ostalom rezultatu + (3001 do 3049) kol. 3 + (3001 do 3049) kol. 4 izveštaja o tokovima gotovine + (4001 do 4264) kol.1  izveštaja o promenama na kapitalu + (9005 +9010+9011+ 9016) kol. 6 + (9017 do 9055) kol. 4 + (9017 do 9055) kol. 5 statističkog izveštaja > 0 Finansijski izveštaj ne sme biti bez podataka; '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Bilans uspeha'
        ...
        lista_si = find_negativni(si, 9001, 9055, 4, 6)
        ...
        #20036
        if not( suma_liste(ioor,[2022,2023,2025,2026],5) == 0 ):
            lzbir =  suma_liste(ioor,[2022,2023,2025,2026],5) 
            dzbir =  0 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Izveštaj o ostalom rezultatu'
            poruka  ='Zbir AOP-a (2022+2023+2025+2026) kol. 5=0 Ukupan neto sveobuhvatni rezultat koji pripada većinskim vlasnicima kapitala, odnosno vlasnicima koji nemaju kontrolu prikazuje se samo u konsolidovanom FI '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #20037
        if not( suma_liste(ioor,[2022,2023,2025,2026],6) == 0 ):
            lzbir =  suma_liste(ioor,[2022,2023,2025,2026],6) 
            dzbir =  0 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Izveštaj o ostalom rezultatu'
            poruka  ='Zbir AOP-a (2022+2023+2025+2026) kol. 6=0 Ukupan neto sveobuhvatni rezultat koji pripada većinskim vlasnicima kapitala, odnosno vlasnicima koji nemaju kontrolu prikazuje se samo u konsolidovanom FI '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        #40085
        if not( suma(iopk,4199, 4220, 1)  == 0 ):
            lzbir =  suma(iopk,4199, 4220, 1)  
            dzbir =  0 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Izveštaj o promenama na kapitalu'
            poruka  ='Zbir AOP-a (4199 do 4220) = 0 Učešće bez prava kontrole prikazuje se samo u konsolidovanom FI '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        #90001
        if not( suma(si,9006,9010,4)+suma(si,9006,9010,5)+suma(si,9006,9010,6)+suma(si,9012,9016,4)+suma(si,9012,9016,5)+suma(si,9012,9016,6)+suma(si,9017,9055,4) > 0 ):
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='Zbir podataka na oznakama za AOP (9006 do 9010) kol. 4 + (9006 do 9010) kol. 5 + (9006 do 9010) kol. 6 + (9012 do 9016) kol. 4 + (9012 do 9016) kol. 5 + (9012 do 9016) kol. 6 + (9017 do 9055) kol. 4 > 0 Statistički izveštaj, po pravilu,  mora imati iskazane podatke za tekući izveštajni period;Ukoliko podaci nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
        ...
        #90002
        if(Zahtev.ObveznikInfo.Novoosnovan == False): 
            if not( aop(si,9005,4)+aop(si,9005,5)+aop(si,9005,6)+aop(si,9011,4)+aop(si,9011,5)+aop(si,9011,6)+suma(si,9017,9055,5) > 0 ):
                
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Zbir podataka na oznakama za AOP 9005 kol. 4 + 9005 kol. 5 + 9005 kol. 6 + 9011 kol. 4 + 9011 kol. 5 + 9011 kol. 6 + (9017 do 9055) kol. 5 > 0 Statistički izveštaj, po pravilu,  mora imati iskazane podatke za prethodni izveštajni period; Ukoliko podaci nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_warnings.append(poruka_obrasca)
        ...
        #90003
        if(Zahtev.ObveznikInfo.Novoosnovan == True): 
            if not( suma(si,9001,9004,4)+aop(si,9005,4)+aop(si,9005,5)+aop(si,9005,6)+aop(si,9011,4)+aop(si,9011,5)+aop(si,9011,6)+suma(si,9017,9055,5) == 0 ):
                lzbir =  suma(si,9001,9004,4)+aop(si,9005,4)+aop(si,9005,5)+aop(si,9005,6)+aop(si,9011,4)+aop(si,9011,5)+aop(si,9011,6)+suma(si,9017,9055,5) 
                dzbir =  0 
                razlika = lzbir - dzbir
                
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Zbir podataka na oznakama za AOP (9001 do 9004) kol. 4 + 9005 kol. 4 + 9005 kol. 5 + 9005 kol. 6 + 9011 kol. 4 + 9011 kol. 5 + 9011 kol. 6 + (9017 do 9055) kol. 5 = 0 Statistički izveštaj za novoosnovane obveznike ne sme imati iskazane podatke za prethodni izveštajni period; '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        #90009
        if( aop(si,9002,3) > 0 ):
            if not( aop(si,9018,4) > 0 ):
                
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9002 kol. 3 > 0, onda je AOP 9018 kol. 4 > 0  Ukoliko u kapitalu učestvuju strana lica, mora biti iskazana vrednost stranog kapitala, ako je veća od 500,00 RSD; Ukoliko podaci o vrednosti kapitala nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje da je vrednost tog kapitala manja od 500,00 RSD; '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_warnings.append(poruka_obrasca)
        ...
        if( aop(si,9018,4) > 0 ):
            if not( aop(si,9002,3) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9018 kol. 4 > 0, onda je AOP 9002 kol. 3 > 0 Ukoliko je iskazana vrednost stranog kapitala, obveznik mora iskazati broj stranih lica koja učestvuju u kapitalu; '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        #90011
        if( aop(si,9002,4) > 0 ):
            if not( aop(si,9018,5) > 0 ):
                
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9002 kol. 4 > 0, onda je AOP 9018 kol. 5 > 0  Ukoliko u kapitalu učestvuju strana lica, mora biti iskazana vrednost stranog kapitala, ako je veća od 500,00 RSD; Ukoliko podaci o vrednosti kapitala nisu prikazani, zakonski zastupnik svojim potpisom potvrđuje da je vrednost tog kapitala manja od 500,00 RSD; '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_warnings.append(poruka_obrasca)
        ...
        if( aop(si,9018,5) > 0 ):
            if not( aop(si,9002,4) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9018 kol. 5 > 0, onda je AOP 9002 kol. 4 > 0 Ukoliko je iskazana vrednost stranog kapitala, obveznik mora iskazati broj stranih lica koja učestvuju u kapitalu; '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(si,9004,3) > 0 ):
            if not( aop(si,9028,4) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9004 kol. 3 > 0, onda je AOP 9028 kol. 4 > 0 Ukoliko je iskazan prosečan broj zaposlenih, obveznik, po pravilu, mora imati iskazane i obaveze po osnovu bruto zarada; Ukoliko jedan od navedenih podataka nije prikazan, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga; '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_warnings.append(poruka_obrasca)
        ...
        if( aop(si,9028,4) > 0 ):
            if not( aop(si,9004,3) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9028 kol. 4 > 0, onda je AOP 9004 kol. 3 > 0 Ukoliko su iskazane obaveze po osnovu bruto zarada, obveznik, po pravilu, mora imati iskazan prosečan broj zaposlenih; Ukoliko jedan od navedenih podataka nije prikazan, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga; '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_warnings.append(poruka_obrasca)
        ...
        if( aop(si,9004,4) > 0 ):
            if not( aop(si,9028,5) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9004 kol. 4 > 0, onda je AOP 9028 kol. 5 > 0 Ukoliko je iskazan prosečan broj zaposlenih, obveznik, po pravilu, mora imati iskazane i obaveze po osnovu bruto zarada; Ukoliko jedan od navedenih podataka nije prikazan, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga; '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_warnings.append(poruka_obrasca)
        ...
        if( aop(si,9028,5) > 0 ):
            if not( aop(si,9004,4) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9028 kol. 5 > 0, onda je AOP 9004 kol. 4 > 0 Ukoliko su iskazane obaveze po osnovu bruto zarada, obveznik, po pravilu, mora imati iskazan prosečan broj zaposlenih; Ukoliko jedan od navedenih podataka nije prikazan, zakonski zastupnik svojim potpisom potvrđuje ispravnost toga; '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_warnings.append(poruka_obrasca)
        ...
        #90020
        if not( aop(si,9005,6) == aop(si,9005,4)-aop(si,9005,5) ):
            lzbir =  aop(si,9005,6) 
            dzbir =  aop(si,9005,4)-aop(si,9005,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9005 kol. 6 = AOP-u 9005 kol. 4 - AOP 9005 kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        #90024
        if not( aop(si,9010,4) == suma_liste(si,[9005,9006,9008,9009],4)-aop(si,9007,4) ):
            lzbir =  aop(si,9010,4) 
            dzbir =  suma_liste(si,[9005,9006,9008,9009],4)-aop(si,9007,4) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9010 kol. 4 = AOP-u (9005 + 9006 - 9007 + 9008 + 9009) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90025
        if not( aop(si,9010,5) == suma_liste(si,[9005,9006,9008,9009],5)-aop(si,9007,5) ):
            lzbir =  aop(si,9010,5) 
            dzbir =  suma_liste(si,[9005,9006,9008,9009],5)-aop(si,9007,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9010 kol. 5 = AOP-u (9005 + 9006 - 9007 + 9008 + 9009) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        ...
        if not( aop(si,9008,4) == 0 ):
            ...
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9008 kol. 4 = 0  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90027
        if not( aop(si,9008,6) == 0 ):
            lzbir =  aop(si,9008,6) 
            dzbir =  0 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9008 kol. 6 = 0  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90028
        if not( aop(si,9016,4) == suma_liste(si,[9011,9012,9014,9015],4)-aop(si,9013,4) ):
            lzbir =  aop(si,9016,4) 
            dzbir =  suma_liste(si,[9011,9012,9014,9015],4)-aop(si,9013,4) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9016 kol. 4 = AOP-u (9011 + 9012 - 9013 + 9014 + 9015) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90029
        if not( aop(si,9016,5) == suma_liste(si,[9011,9012,9014,9015],5)-aop(si,9013,5) ):
            lzbir =  aop(si,9016,5) 
            dzbir =  suma_liste(si,[9011,9012,9014,9015],5)-aop(si,9013,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9016 kol. 5 = AOP-u (9011 + 9012 - 9013 + 9014 + 9015) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90030
        if not( aop(si,9014,4) == 0 ):
            lzbir =  aop(si,9014,4) 
            dzbir =  0 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9014 kol. 4 = 0  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90031
        if not( aop(si,9014,6) == 0 ):
            lzbir =  aop(si,9014,6) 
            dzbir =  0 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9014 kol. 6 = 0  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90032
        if not( aop(si,9005,6) == aop(bs,2,6) ):
            lzbir =  aop(si,9005,6) 
            dzbir =  aop(bs,2,6) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 9005 kol. 6 = AOP-u 0002 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90033
        if not( aop(si,9010,6) == aop(bs,2,5) ):
            lzbir =  aop(si,9010,6) 
            dzbir =  aop(bs,2,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 9010 kol. 6 = AOP-u 0002 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90034
        if not( aop(si,9011,6) == aop(bs,3,6) ):
            lzbir =  aop(si,9011,6) 
            dzbir =  aop(bs,3,6) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 9011 kol. 6 = AOP-u 0003 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90035
        if not( aop(si,9016,6) == aop(bs,3,5) ):
            lzbir =  aop(si,9016,6) 
            dzbir =  aop(bs,3,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 9016 kol. 6 = AOP-u 0003 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90036
        if not( aop(si,9018,4) <= aop(si,9017,4) ):
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9018 kol. 4 ≤ AOP-a 9017 kol. 4  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90037
        if not( aop(si,9018,5) <= aop(si,9017,5) ):
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9018 kol. 5 ≤ AOP-a 9017 kol. 5  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90038
        if not( aop(si,9017,4) == aop(bs,402,5) ):
            lzbir =  aop(si,9017,4) 
            dzbir =  aop(bs,402,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 9017 kol. 4 = AOP-u 0402 kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90039
        if not( aop(si,9017,5) == aop(bs,402,6) ):
            lzbir =  aop(si,9017,5) 
            dzbir =  aop(bs,402,6) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 9017 kol. 5 = AOP-u 0402 kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        if( aop(si,9019,4) > 0 ):
            if not( aop(si,9020,4) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9019 kol. 4 > 0, onda je AOP 9020 kol. 4 > 0 Ako je prikazan broj akcija, mora biti prikazana i vrednost akcija '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(si,9020,4) > 0 ):
            if not( aop(si,9019,4) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9020 kol. 4 > 0, onda je AOP 9019 kol. 4 > 0 Ako je prikazana vrednost akcija, mora biti prikazan broj akcija '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(si,9019,5) > 0 ):
            if not( aop(si,9020,5) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9019 kol. 5 > 0, onda je AOP 9020 kol. 5 > 0 Ako je prikazan broj akcija, mora biti prikazana i vrednost akcija '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        #90043
        if( aop(si,9020,5) > 0 ):
            if not( aop(si,9019,5) > 0 ):
                
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9020 kol. 5 > 0, onda je AOP 9019 kol. 5 > 0 Ako je prikazana vrednost akcija, mora biti prikazan broj akcija '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(si,9021,4) > 0 ):
            if not( aop(si,9022,4) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9021 kol. 4 > 0, onda je AOP 9022 kol. 4 > 0 Ako je prikazan broj akcija, mora biti prikazana i vrednost akcija '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        #90045
        if( aop(si,9022,4) > 0 ):
            if not( aop(si,9021,4) > 0 ):
                
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9022 kol. 4 > 0, onda je AOP 9021 kol. 4 > 0 Ako je prikazana vrednost akcija, mora biti prikazan broj akcija '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        if( aop(si,9021,5) > 0 ):
            if not( aop(si,9022,5) > 0 ):
                ...
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9021 kol. 5 > 0, onda je AOP 9022 kol. 5 > 0 Ako je prikazan broj akcija, mora biti prikazana i vrednost akcija '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        ...
        #90047
        if( aop(si,9022,5) > 0 ):
            if not( aop(si,9021,5) > 0 ):
                
                naziv_obrasca='Statistički izveštaj'
                poruka  ='Ako je AOP 9022 kol. 5 > 0, onda je AOP 9021 kol. 5 > 0 Ako je prikazana vrednost akcija, mora biti prikazan broj akcija '
                aop_pozicije=[]
                poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
                form_errors.append(poruka_obrasca)
        
        #90048
        if not( aop(si,9023,4) == suma_liste(si,[9020,9022],4) ):
            lzbir =  aop(si,9023,4) 
            dzbir =  suma_liste(si,[9020,9022],4) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9023 kol. 4 = AOP-u (9020 + 9022) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90049
        if not( aop(si,9023,5) == suma_liste(si,[9020,9022],5) ):
            lzbir =  aop(si,9023,5) 
            dzbir =  suma_liste(si,[9020,9022],5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9023 kol. 5 = AOP-u (9020 + 9022) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90050
        if not( aop(si,9023,4) == aop(si,9017,4) ):
            lzbir =  aop(si,9023,4) 
            dzbir =  aop(si,9017,4) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9023 kol. 4 = AOP-u 9017 kol. 4 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90051
        if not( aop(si,9023,5) == aop(si,9017,5) ):
            lzbir =  aop(si,9023,5) 
            dzbir =  aop(si,9017,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9023 kol. 5 = AOP-u 9017 kol. 5 Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90052
        if not( aop(si,9033,4) == suma(si,9024,9032,4) ):
            lzbir =  aop(si,9033,4) 
            dzbir =  suma(si,9024,9032,4) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9033 kol. 4 = AOP-u (9024 + 9025 + 9026 + 9027 + 9028 + 9029 + 9030 + 9031 + 9032) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90053
        if not( aop(si,9033,5) == suma(si,9024,9032,5) ):
            lzbir =  aop(si,9033,5) 
            dzbir =  suma(si,9024,9032,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9033 kol. 5 = AOP-u (9024 + 9025 + 9026 + 9027 + 9028 + 9029 + 9030 + 9031 + 9032) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90054
        if not( suma(si,9028,9031,4) <= aop(si,9027,4) ):
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP (9028 + 9029 + 9030 + 9031) kol. 4 ≤ AOP-a 9027 kol. 4  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90055
        if not( suma(si,9028,9031,5) <= aop(si,9027,5) ):
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP (9028 + 9029 + 9030 + 9031) kol. 5 ≤ AOP-a 9027 kol. 5  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90056
        if not( aop(si,9024,4) == suma(bs,17,18,5) ):
            lzbir =  aop(si,9024,4) 
            dzbir =  suma(bs,17,18,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 9024 kol. 4 = AOP-u (0017 + 0018) kol. 5 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90057
        if not( aop(si,9024,5) == suma(bs,17,18,6) ):
            lzbir =  aop(si,9024,5) 
            dzbir =  suma(bs,17,18,6) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Bilans stanja'
            poruka  ='AOP 9024 kol. 5 = AOP-u (0017 + 0018) kol. 6 bilansa stanja Kontrolno pravilo zahteva računsko slaganje istovrsnih podataka prikazanih u različitim obrascima u finansijskom izveštaju  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90058
        if not( aop(si,9050,4) == suma(si,9034,9049,4) ):
            lzbir =  aop(si,9050,4) 
            dzbir =  suma(si,9034,9049,4) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9050 kol. 4 = Zbiru AOP-a (od 9034 do 9049) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90059
        if not( aop(si,9050,5) == suma(si,9034,9049,5) ):
            lzbir =  aop(si,9050,5) 
            dzbir =  suma(si,9034,9049,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9050 kol. 5 = Zbiru AOP-a (od 9034 do 9049) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90060
        if not( suma_liste(si,[9041,9048],4) <= aop(si,9049,4) ):
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP (9041 + 9048) kol. 4 ≤ AOP-a 9049 kol. 4  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90061
        if not( suma_liste(si,[9041,9048],5) <= aop(si,9049,5) ):
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP (9041 + 9048) kol. 5 ≤ AOP-a 9049 kol. 5  '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90062
        if not( aop(si,9035,4) <= aop(si,9028,4) ):
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9035 kol. 4 ≤ AOP-a 9028 kol. 4  Troškovi zarada su, po pravilu, manji ili jednaki obavezama za bruto zarade '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
        
        #90063
        if not( aop(si,9035,5) <= aop(si,9028,5) ):
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9035 kol. 5 ≤ AOP-a 9028 kol. 5 Troškovi zarada su, po pravilu, manji ili jednaki obavezama za bruto zarade '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_warnings.append(poruka_obrasca)
        
        #90064
        if not( suma_liste(si,[9034,9040,9042],4) <= aop(bu,1005,5) ):
            
            naziv_obrasca='Bilans uspeha'
            poruka  ='Zbir AOP-a (9034 + 9040 + 9042) kol. 4 ≤ AOP-a 1005 kol. 5 bilansa uspeha Troškovi goriva i energije, zakupnina, amortizacije i rezervisanja su izdvojeni deo ostalih poslovnih rashoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90065
        if not( suma_liste(si,[9034,9040,9042],5) <= aop(bu,1005,6) ):
            
            naziv_obrasca='Bilans uspeha'
            poruka  ='Zbir AOP-a (9034 + 9040 + 9042) kol. 5 ≤ AOP-a 1005 kol. 6 bilansa uspeha Troškovi goriva i energije, zakupnina, amortizacije i rezervisanja su izdvojeni deo ostalih poslovnih rashoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90066
        if not( suma(si,9035,9039,4) <= aop(bu,1004,5) ):
            
            naziv_obrasca='Bilans uspeha'
            poruka  ='Zbir AOP-a (9035 + 9036 + 9037 + 9038 + 9039) kol. 4 ≤ AOP-a 1004 kol. 5 bilansa uspeha Troškovi zarada, poreza i doprinosa na zarade na teret poslodavca, naknada fizičkim licima po osnovu ugovora, naknada članovima uprave i ostali lični rashodi su izdvojeni deo troškova zarada, naknada i ostalih ličnih rashoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90067
        if not( suma(si,9035,9039,5) <= aop(bu,1004,6) ):
            
            naziv_obrasca='Bilans uspeha'
            poruka  ='Zbir AOP-a (9035 + 9036 + 9037 + 9038 + 9039) kol. 5 ≤ AOP-a 1004 kol. 6 bilansa uspeha Troškovi zarada, poreza i doprinosa na zarade na teret poslodavca, naknada fizičkim licima po osnovu ugovora, naknada članovima uprave i ostali lični rashodi su izdvojeni deo troškova zarada, naknada i ostalih ličnih rashoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90068
        if not( suma_liste(si,[9043,9044,9045,9046,9047,9049],4) <= aop(bu,1023,5) ):
            
            naziv_obrasca='Bilans uspeha'
            poruka  ='Zbir AOP-a (9043 + 9044 + 9045 + 9046 + 9047 + 9049) kol. 4 ≤ AOP-a 1023 kol. 5 bilansa uspeha Troškovi premija osiguranja, platnog prometa, članarina, poreza, doprinosa i ostalih nematerijalnih troškova su izdvojeni deo ostalih rashoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90069
        if not( suma_liste(si,[9043,9044,9045,9046,9047,9049],5) <= aop(bu,1023,6) ):
            
            naziv_obrasca='Bilans uspeha'
            poruka  ='Zbir AOP-a (9043 + 9044 + 9045 + 9046 + 9047 + 9049) kol. 5 ≤ AOP-a 1023 kol. 6 bilansa uspeha Troškovi premija osiguranja, platnog prometa, članarina, poreza, doprinosa i ostalih nematerijalnih troškova su izdvojeni deo ostalih rashoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90070
        if not( aop(si,9055,4) == suma(si,9051,9054,4) ):
            lzbir =  aop(si,9055,4) 
            dzbir =  suma(si,9051,9054,4) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9055 kol. 4 = AOP-u (9051 + 9052 + 9053 + 9054) kol. 4  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90071
        if not( aop(si,9055,5) == suma(si,9051,9054,5) ):
            lzbir =  aop(si,9055,5) 
            dzbir =  suma(si,9051,9054,5) 
            razlika = lzbir - dzbir
            
            naziv_obrasca='Statistički izveštaj'
            poruka  ='AOP 9055 kol. 5 = AOP-u (9051 + 9052 + 9053 + 9054) kol. 5  '+'(Levi zbir = '+'' +str(lzbir)+ ''+', Desni zbir = '+'' +str(dzbir)+ ''+', Razlika = '+'' +str(razlika)+ ''+') '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
        
        #90072
        if not( suma(si,9051,9054,4) <= aop(bu,1022,5) ):
            
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP (9051 + 9052 + 9053 + 9054) kol. 4 ≤ AOP-a 1022 kol. 5 bilansa uspeha Prihodi od povraćaja poreskih dažbina, po osnovu donacija, od zakupnina za zemljište i po osnovu članstva su izdvojeni deo ostalih prihoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
        ...
        #90073
        if not( suma(si,9051,9054,5) <= aop(bu,1022,6) ):
            
            naziv_obrasca='Bilans uspeha'
            poruka  ='AOP (9051 + 9052 + 9053 + 9054) kol. 5 ≤ AOP-a 1022 kol. 6 bilansa uspeha Prihodi od povraćaja poreskih dažbina, po osnovu donacija, od zakupnina za zemljište i po osnovu članstva su izdvojeni deo ostalih prihoda '
            aop_pozicije=[]
            poruka_obrasca = {'naziv_obrasca': naziv_obrasca, 'poruka': poruka, 'aop_pozicije': aop_pozicije}
            form_errors.append(poruka_obrasca)
            naziv_obrasca='Statistički izveštaj'
